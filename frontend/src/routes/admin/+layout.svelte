...
<div class="min-h-screen bg-slate-50 font-sans flex">
	...
	<aside class="w-64 bg-white border-r border-slate-200 hidden md:block fixed h-full z-10">
		...
		<div class="p-4 space-y-1">
			...
			<a href="/admin/akreditasi" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-700 font-medium hover:bg-slate-50 hover:text-blue-600 transition-colors">
	...
	<div class="flex-1 md:ml-64 flex flex-col h-screen overflow-hidden">
		...
		{#if isMenuOpen}
			<div class="md:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-4 space-y-1">
				...
				<a href="/admin/akreditasi" class="block px-3 py-2 rounded-lg text-slate-700 font-medium hover:bg-slate-50">Dokumen Akreditasi</a>
