...
//#region node_modules/prettier/plugins/html.js
var require_html = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(f) {
		...
		var Ir = (e, t) => {
			...
			if (t && typeof t == "object" || typeof t == "function") for (let i of es(t)) !ts.call(e, i) && i !== r && ot(e, i, {
				get: () => t[i],
		...
		var zt = (e, t, r) => rs(e, typeof t != "symbol" ? t + "" : t, r), ss = (e, t, r) => t.has(e) || Dr("Cannot " + r);
		var qe = (e, t, r) => (ss(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Rr = (e, t, r) => t.has(e) ? Dr("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
		var Xo = {};
		Ir(Xo, {
			languages: () => Ui,
			options: () => zi,
		...
		var I = ke("at", function() {
			if (Array.isArray(this) || typeof this == "string") return ls;
		});
		var us = () => {}, He = us;
		var Fe = "string", Ve = "array", lt = "cursor", be = "indent", we = "align", ct = "trim", Te = "group", ye = "fill", Ee = "if-break", xe = "indent-if-break", ut = "line-suffix", pt = "line-suffix-boundary", z = "line", ht = "label", Le = "break-parent", mt = /* @__PURE__ */ new Set([
			lt,
			be,
			we,
			ct,
		...
		var dt = ps;
		var hs = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
		function ms(e) {
...
Expected it to be ${n}.`;
		...
		function L(e, t = Mr) {
			return $t(e, (r) => typeof r == "string" ? R(t, r.split(`
`)) : r);
		}
		var D = He, gt = He, Br = He, qr = He;
		function A(e) {
			return D(e), {
				type: be,
				contents: e
		...
		function C(e, t = {}) {
			return D(e), gt(t.expandedStates, !0), {
				type: Te,
				id: t.id,
				contents: e,
				break: !!t.shouldBreak,
		...
		function Wr(e, t) {
			let { preferred: r, alternate: n } = t === !0 || t === "'" ? _s : Ss, { length: i } = e, s = 0, a = 0;
			for (let o = 0; o < i; o++) {
		...
		var Yt = class {
			...
			split(t, r = !1) {
				let n = `[${jt([...this.#e].join(""))}]+`, i = new RegExp(r ? `(${n})` : n);
				return t.split(i);
			}
...
`,
		...
		var $r = ks;
		var se = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty);
		var ws = Array.prototype.toReversed ?? function() {
			return [...this].reverse();
		...
		function Ds(e, t) {
			...
			return (Ps(r, t.language) ?? Xr(r, t.physicalFile) ?? Xr(r, t.file) ?? Jr(r, t.physicalFile) ?? Jr(r, t.file) ?? Ns?.(r, t.physicalFile))?.parsers[0];
		}
		var St = Ds;
...
`)), I(0, c, -1).length;
		...
		function kt(e, t) {
			return !!(e.kind === "ieConditionalComment" && e.lastChild && !e.lastChild.isSelfClosing && !e.lastChild.endSourceSpan || e.kind === "ieConditionalComment" && !e.complete || Y(e) && e.children.some((r) => r.kind !== "text" && r.kind !== "interpolation") || Tt(e, t) && !O(e, t) && e.kind !== "interpolation");
		}
		function le(e) {
		...
		function sn(e, t) {
			...
			return r;
			function n() {
				return ae(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.prev && (e.prev.kind === "text" || e.prev.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : Y(e.parent) ? !0 : !(!e.prev && (e.parent.kind === "root" || Y(e) && e.parent || O(e.parent, t) || Ge(e.parent, t) || !Gs(e.parent.cssDisplay)) || e.prev && !Ys(e.prev.cssDisplay));
			}
		}
		function an(e, t) {
			return ae(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.next && (e.next.kind === "text" || e.next.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : Y(e.parent) ? !0 : !(!e.next && (e.parent.kind === "root" || Y(e) && e.parent || O(e.parent, t) || Ge(e.parent, t) || !$s(e.parent.cssDisplay)) || e.next && !js(e.next.cssDisplay));
		}
		function on(e, t) {
		...
		function ln(e) {
			return rr(e) || e.kind === "element" && e.children.length > 0 && ([
				"body",
				"script",
				"style"
			].includes(e.name) || e.children.some((t) => Vs(t))) || e.firstChild && e.firstChild === e.lastChild && e.firstChild.kind !== "text" && un(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || pn(e.lastChild));
		}
		function rr(e) {
		...
		function fn(e, t) {
			...
			let r = !1;
			if (e.kind === "element" && e.namespace === "svg") if (Qs(e, (n) => n.fullName === "svg:foreignObject")) r = !0;
			else return e.name === "svg" ? "inline-block" : "block";
			switch (t.htmlWhitespaceSensitivity) {
				case "strict": return "inline";
				case "ignore": return "block";
				default: if (e.kind === "element" && (!e.namespace || r || oe(e)) && se(Jt, e.name)) return Jt[e.name];
			}
			return Zr;
		}
		function dn(e) {
			return e.kind === "element" && (!e.namespace || oe(e)) && se(Zt, e.name) ? Zt[e.name] : en;
		}
		function ir(e) {
			return T(0, T(0, e, "&apos;", "'"), "&quot;", "\"");
		}
		...
		function yt(e, t = e.value) {
			return e.parent.isWhitespaceSensitive ? e.parent.isIndentationSensitive ? L(t) : L(P.dedentString(er(t)), k) : R(S, P.split(t));
		}
		function Et(e, t) {
		...
		var sr = (e) => (t, r, n) => E(w(n.node), t, { parser: e }, q), Zs = [
			{
				test(e) {
		...
		var ra = /* @__PURE__ */ new Set([
			...
			"onwaiting",
			"onwheel"
		]), Tn = ({ node: e }, t) => ra.has(e.fullName) && !t.parentParser && !e.value.includes("{{"), yn = (e, t, r) => E(w(r.node), e, {
			parser: "babel",
...
` || e === "\f" || e === "\r" || e === " ";
		...
		var ia = /^[ \t\n\r\u000c]+/, sa = /^[, \t\n\r\u000c]+/, aa = /^[^ \t\n\r\u000c]+/, oa = /[,]+$/, Pn = /^\d+$/, la = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;
		function ca(e) {
			...
			for (;;) {
				...
				l = o, r = c(aa), n = [], r.slice(-1) === "," ? (r = r.replace(oa, ""), _()) : d();
			}
			function d() {
			...
			function _() {
				let h = !1, f, g, v, W, ie = {}, Q, at, Ce, Be, Wt;
				for (W = 0; W < n.length; W++) Q = n[W], at = Q[Q.length - 1], Ce = Q.substring(0, Q.length - 1), Be = parseInt(Ce, 10), Wt = parseFloat(Ce), Pn.test(Ce) && at === "w" ? ((f || g) && (h = !0), Be === 0 ? h = !0 : f = Be) : la.test(Ce) && at === "x" ? ((f || g || v) && (h = !0), Wt < 0 ? h = !0 : g = Wt) : Pn.test(Ce) && at === "h" ? ((v || g) && (h = !0), Be === 0 ? h = !0 : v = Be) : h = !0;
				if (!h) ie.source = {
					value: r,
					startOffset: l
		...
		function Rn(e, t, r) {
			let i = Nn(w(r.node)), s = ua.filter((h) => i.some((f) => se(f, h)));
		...
		var On = ({ node: e }, t) => e.fullName === "style" && !t.parentParser && !e.value.includes("{{"), Mn = async (e, t, r) => j(await e(w(r.node), {
			parser: "css",
			__isHTMLStyleAttribute: !0
		}));
		var pa = /* @__PURE__ */ new WeakMap();
		function ha(e, t) {
			return ft(pa, e.root, (r) => r.children.some((n) => Et(n, t) && ["ts", "typescript"].includes(n.attrMap.lang)));
		}
		var H = ha;
		function Bn(e, t, r) {
		...
		async function Hn(e, t, r, n) {
			let { left: s, operator: a, right: o } = ma(w(r.node)), l = H(r, n);
			return [
		...
		function va(e) {
			return async (t, r, n, i) => {
				...
				if (s) return s = $t(s, (a) => typeof a == "string" ? T(0, a, "\"", "&quot;") : a), [
					n.node.rawName,
					"=\"",
					C(s),
					"\""
		...
		function he(e) {
			return e.lastChild?.isTrailingSpaceSensitive && !e.lastChild.hasTrailingSpaces && !N(wt(e.lastChild)) && !Y(e);
		}
		function K(e) {
			return !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && N(wt(e));
		}
		function je(e) {
		...
		function wa(e, t, r) {
			...
			let a = n.prev?.kind === "comment" && ba(n.prev.value), o = typeof a == "boolean" ? () => a : Array.isArray(a) ? (g) => a.includes(g.rawName) : () => !1, l = ["attrs", "startTagComments"].filter((g) => X(n[g])), c = l.flatMap((g) => e.map(({ node: v }) => ({
				loc: F(v),
		...
		function ya(e, t) {
			...
			return e.lastChild && K(e.lastChild) ? n += Lt(e, t).length : he(e) && (n -= pe(e.lastChild, t).length), t.originalText.slice(r, n);
		}
		var Nt = ya;
			...
			switch (r.kind) {
				case "element":
					...
					if (!r.isSelfClosing && Tt(r, t)) {
						let n = nr(r, t);
						return n ? async (i, s) => {
							let a = Nt(r, t), o = /^\s*$/.test(a), l = "";
							return o || (l = await i(er(a), {
								parser: n,
								__embeddedInHtml: !0
							}), o = l === ""), [
								B(r, t),
				...
				case "angularControlFlowBlockParameters": return Ea.has(e.parent.name) ? $r : void 0;
		...
		function lr(e, t, r) {
			...
			if (e.kind === "docType" && (t.value = T(0, e.value.toLowerCase(), /\s+/g, " ")), e.kind === "angularControlFlowBlock" && e.parameters?.children) for (let n of t.parameters.children) Da.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
${e}`;
		...
		function Ze(e, t, r) {
			...
			if (le(n)) {
				...
				return [
					B(n, t),
					L(P.trimEnd(t.originalText.slice(F(n) + (n.prev && je(n.prev) ? At(n).length : 0), i - (n.next && V(n.next) ? pe(n, t).length : 0)))),
					M(n, t)
				];
			}
			return r();
		...
		function Ae(e, t, r) {
			...
			return e.map(({ node: s, index: a }) => {
				...
				let o = [], l = [], c = [], u = [], d = s.prev ? Dt(s.prev, s) : "", _ = s.next ? Dt(s, s.next) : "";
		...
		var Ia = (e) => e?.kind === "angularControlFlowBlock" && (e.name === "case" || e.name === "default"), Ra = (e) => e?.kind === "angularControlFlowBlock" && e.name === "default never";
		function Oa(e) {
			return Ia(e) && e.endSourceSpan && e.endSourceSpan.start.offset === e.endSourceSpan.end.offset;
		}
		function Ma(e) {
			let { previous: t } = e;
		...
		function qa() {
			return et || (et = hr(), ee(1, void 0, [["iframe", ["srcdoc"]], ["*", ["innerHTML", "outerHTML"]]]), ee(2, void 0, [["*", ["style"]]]), ee(4, void 0, [
				["*", ["formAction"]],
				["area", ["href"]],
				["a", ["href", "xlink:href"]],
				["form", ["action"]],
				["img", ["src"]],
				["video", ["src"]]
			]), ee(4, Ba, [["*", ["href", "xlink:href"]]]), ee(5, void 0, [
				["base", ["href"]],
				["embed", ["src"]],
				["frame", ["src"]],
				["iframe", ["src"]],
		...
		function ee(e, t, r) {
			...
			for (let [s, a] of r) {
				...
				for (let l of a) {
					var i;
					let c = l.toLowerCase(), u = (i = et)[c] ?? (i[c] = hr()), d = u[n] ?? (u[n] = hr());
					d[o] = e;
				}
			}
		}
		...
		var mr = { name: "custom-elements" }, fr = { name: "no-errors-schema" };
		var Ha = /-+([a-z0-9])/g;
		function pi(e) {
			return e.replace(Ha, (...t) => t[1].toUpperCase());
		}
		var hi = class {};
		var Fa = "boolean", Va = "number", Ua = "string", Wa = "object";
		function It(e) {
		...
		var za = [
		...
		})), Ga = Array.from(mi).reduce((e, [t, r]) => (e.set(t, r), e), /* @__PURE__ */ new Map()), fi = class extends hi {
			...
			hasElement(e, t) {
				...
				let r = It(e);
				return r.includes("-") && (ur(r) || pr(r) || t.some((n) => n.name === mr.name)) ? !0 : this._schema.has(r);
			}
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`
			...
			allKnownAttributesOfElement(e) {
				let t = It(e), r = this._schema.get(t) || this._schema.get("unknown");
			...
			normalizeAnimationStyleValue(e, t, r) {
				...
				if ($a(e) && r !== 0 && r !== "0") if (typeof r == "number") n = "px";
				else {
					let a = r.match(/^[+-]?[\d\.]+([a-z]*)$/);
...
` && ++o == r)););
			...
			contextualMessage() {
				...
				return e ? `${this.msg} ("${e.before}[${ja[this.level]} ->]${e.after}")` : this.msg;
			}
			toString() {
...
`,
		...
		function Di(e, t, r, n = {}) {
			...
			return i.tokenize(), new Ya(oo(i.tokens), i.errors, i.nonNormalizedIcuExpressions);
		}
		var Ka = /\r\n?/g;
		function Se(e) {
		...
		var Xa = [
			...
			constructor(e, t, r) {
				...
				this._cursor = r.escapedString ? new lo(e, n) : new Ii(e, n), this._preserveLineEndings = r.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = r.tokenizeBlocks ?? !0, this._tokenizeLet = r.tokenizeLet ?? !0, this._selectorlessEnabled = r.selectorlessEnabled ?? !1;
				try {
					this._cursor.init();
				} catch (i) {
					this.handleError(i);
			...
			_processCarriageReturns(e) {
				return this._preserveLineEndings ? e : e.replace(Ka, `
`);
			}
			tokenize() {
			...
			_getBlockName() {
				...
				this._attemptCharCodeUntilFn((n) => nt(n) ? !e : ao(n) ? (e = !0, !1) : !0);
				let r = this._cursor.getChars(t).trim();
				return Za.test(r) ? r = "else if" : Ja.test(r) && (r = "default never"), r;
			}
			...
			_consumeLetDeclarationValue() {
				...
				for (this._beginToken(32, e); this._cursor.peek() !== 0;) {
					...
					if (t === 59) break;
					Ot(t) && (this._cursor.advance(), this._attemptCharCodeUntilFn((r) => r === 92 ? (this._cursor.advance(), !1) : r === t)), this._cursor.advance();
				}
				this._endToken([this._cursor.getChars(e)]);
			}
			_tokenizeExpansionForm() {
				if (this.isExpansionFormStart()) return this._consumeExpansionFormStart(), !0;
				if (io(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
			...
			handleError(e) {
				if (e instanceof kr && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof te) this.errors.push(e);
				else throw e;
			}
			_attemptCharCode(e) {
			...
			_consumeEntity(e) {
				...
				if (this._cursor.advance(), this._attemptCharCode(35)) {
					...
					if (this._attemptCharCodeUntilFn(ro), this._cursor.peek() != 59) {
						...
						throw this._createError(Qa(s, this._cursor.getChars(t)), this._cursor.getSpan());
					}
			...
			_consumePrefixAndName(e) {
				...
				for (; this._cursor.peek() !== 58 && !to(this._cursor.peek());) this._cursor.advance();
				let n;
			...
			_consumeTagOpen(e) {
				let t, r, n, i, s = [];
				try {
					if (this._selectorlessEnabled && Mt(this._cursor.peek())) i = this._consumeComponentOpenStart(e), [n, r, t] = i.parts, r && (n += `:${r}`), t && (n += `:${t}`), this._attemptCharCodeUntilFn(b);
					else {
			...
			_consumeInterpolation(e, t, r) {
				...
				for (; this._cursor.peek() !== 0 && (r === null || !r());) {
					...
					this._cursor.advance(), l === 92 ? this._cursor.advance() : l === s ? s = null : !a && s === null && Ot(l) && (s = l);
				}
		...
		var Ii = class vr {
			...
			advanceState(t) {
				if (t.offset >= this.end) throw this.state = t, new kr("Unexpected character \"EOF\"", this);
			...
			processEscapeSequence() {
				...
				if (t() === 92) if (this.internalState = { ...this.state }, this.advanceState(this.internalState), t() === 110) this.state.peek = 10;
					...
					for (; Sr(t()) && n < 3;) i = this.clone(), r += String.fromCodePoint(t()), this.advanceState(this.internalState), n++;
			...
			decodeHexDigits(t, r) {
				...
				if (isNaN(i)) throw t.state = t.internalState, new kr("Invalid hexadecimal escape sequence", t);
				return i;
			}
		...
		var x = class Mi extends te {
			...
			parse(e, t, r, n = !1, i) {
				...
				} : o, r), u = r && r.canSelfClose || !1, d = r && r.allowHtmComponentClosingTags || !1, _ = new uo(c.tokens, a, u, d, n);
...
`) {
			...
			_consumeLet(t) {
				...
				let s = i.sourceSpan.end, a = new p(t.sourceSpan.start, s, t.sourceSpan.fullStart), o = t.sourceSpan.toString().lastIndexOf(r), l = new p(t.sourceSpan.start.moveBy(o), t.sourceSpan.end), c = new gr(r, n.parts[0], a, l, n.sourceSpan);
				this._addToParent(c);
			}
			_consumeIncompleteLet(t) {
				let r = t.parts[0] ?? "", n = r ? ` "${r}"` : "";
				if (r.length > 0) {
					let i = t.sourceSpan.toString().lastIndexOf(r), s = new p(t.sourceSpan.start.moveBy(i), t.sourceSpan.end), a = new p(t.sourceSpan.start, t.sourceSpan.start.moveBy(0)), o = new gr(r, "", t.sourceSpan, s, a);
					this._addToParent(o);
				}
		...
		function Bt(e, t = {}) {
			...
			return br ?? (br = new Hi()), br.parse(e, "angular-html-parser", {
...
`) {
		...
		function _o(e) {
			return go(e, (t) => t.kind === "cdata", (t) => `<![CDATA[${t.value}]]>`);
		}
		function So(e) {
		...
		function yo(e, t, r) {
			...
			switch (n.kind) {
				...
				case "attribute": {
					...
					let i = ir(n.value), s = xt(n, t) ? "" : Wr(i, "\"");
					return [
						n.rawName,
						"=",
						s,
		...
		function Tr(e) {
			...
			return {
				...
				getTagContentType: s ? (...l) => s(...l) ? cr.RAW_TEXT : void 0 : void 0,
		...
		var Ft = {
			...
			cases: !0,
			expression: !0
		}, ji = /* @__PURE__ */ new Set(["parent"]), ne, yr, Er, Me = class Me {
			constructor(t = {}) {
				Rr(this, ne);
				zt(this, "kind");
				zt(this, "parent");
			...
			setProperty(t, r) {
				if (this[t] !== r) {
					if (t in Ft && (r = r.map((n) => this.createChild(n))), !ji.has(t)) {
						this[t] = r;
						return;
					}
		...
		ne = /* @__PURE__ */ new WeakSet(), yr = function() {
		...
		function Yi(e, t) {
			if (e.value) for (let { regex: r, parse: n } of No) {
		...
		function Vo(e, t) {
			if (e.kind === "element" && (t.normalizeTagName && (!e.namespace || e.namespace === e.tagDefinition.implicitNamespacePrefix || oe(e)) && (e.name = Ki(e.name, (r) => $i.has(r))), t.normalizeAttributeName)) for (let r of e.attrs) r.namespace || (r.name = Ki(r.name, (n) => Ht.has(e.name) && (Ht.get("*").has(n) || Ht.get(e.name).has(n))));
		}
		function Ar(e, t) {
			let { rootNodes: r, errors: n } = Bt(e, Tr(t));
			return n.length > 0 && Lr(n[0]), {
				parseOptions: t,
				rootNodes: r
			};
		}
		function Ji(e, t) {
			let r = Tr(t), { rootNodes: n, errors: i } = Bt(e, r);
			if (n.some((c) => c.kind === "docType" && c.value === "html" || c.kind === "element" && c.name.toLowerCase() === "html")) return Ar(e, Ut);
			let a, o = () => a ?? (a = Bt(e, {
				...r,
		...
		function Wo(e, t, r, n, i, s) {
			let { offset: a } = n, l = Pr(Ct(t.slice(0, a)) + r, e, {
				...i,
		...
		function Pr(e, t, r, n = {}) {
			let { frontMatter: i, content: s } = r.shouldParseFrontMatter ? Xt(e) : { content: e }, a = new rt(e, n.filepath), o = new De(a, 0, 0, 0), l = o.moveBy(e.length), { parseOptions: c, rootNodes: u } = t(s, r), d = {
				kind: "root",
				sourceSpan: new p(o, l),
				children: u
			}, _;
		...
		var zo = st(Ut), Go = /* @__PURE__ */ new Set(["mj-style", "mj-raw"]), $o = st({
			...Ut,
			name: "mjml",
			shouldParseAsRawText: (e) => Go.has(e)
		}), jo = st({
			name: "angular",
