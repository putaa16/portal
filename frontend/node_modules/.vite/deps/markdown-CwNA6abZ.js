...
//#region node_modules/prettier/plugins/markdown.js
var require_markdown = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(n) {
		...
		var cm = Object.getPrototypeOf, fm = Object.prototype.hasOwnProperty;
		var q = (e, t) => () => {
			try {
			...
			if (t && typeof t == "object" || typeof t == "function") for (let a of lm(t)) !fm.call(e, a) && a !== r && Pr(e, a, {
				get: () => t[a],
				enumerable: !(n = sm(t, a)) || n.enumerable
			});
			return e;
		};
		var At = (e, t, r) => (r = e != null ? om(cm(e)) : {}, xu(t || !e || !e.__esModule ? Pr(r, "default", {
			value: e,
			enumerable: !0
		}) : r, e)), pm = (e) => xu(Pr({}, "__esModule", { value: !0 }), e);
		var bo = q((k8, Fo) => {
			"use strict";
			Fo.exports = wg;
			var sr = 9, en = 10, _t = 32, kg = 33, Fg = 58, Pt = 91, bg = 92, Pi = 93, lr = 94, tn = 96, rn = 4, Eg = 1024;
			function wg(e) {
			...
			function vg(e, t) {
				...
				function D(w, d, v) {
					...
					if (d.charCodeAt(I++) === Pt && d.charCodeAt(I++) === lr) {
						for (O = I; I < _;) {
							if (N = d.charCodeAt(I), N !== N || N === en || N === sr || N === _t) return;
							if (N === Pi) {
								z = I, I++;
								break;
							}
						...
						if (!(z === void 0 || O === z || d.charCodeAt(I++) !== Fg)) {
							...
							for (R = d.slice(O, z), W = w.now(), ie = 0, F = 0, ee = I, ce = []; I < _;) {
								...
								else if (F !== void 0) if (N === _t || N === sr) F += N === _t ? 1 : rn - F % rn, F > rn && (F = void 0, ee = I);
								else {
									if (F < rn && te && (te.contentStart === te.contentEnd || Tg(y, a, L, [
										w,
										d.slice(I, Eg),
										!0
									]))) break;
				...
				function x(w, d, v) {
					...
					if (d.charCodeAt(y++) === Pt && d.charCodeAt(y++) === lr) {
						for (_ = y; y < L;) {
							if (T = d.charCodeAt(y), T !== T || T === en || T === sr || T === _t) return;
							if (T === Pi) {
								I = y, y++;
								break;
							}
					...
					if (d.charCodeAt(b++) === lr && d.charCodeAt(b++) === Pt) {
						for (R = b; b < y;) {
							...
							if (N === void 0) if (T === bg) b += 2;
								...
								for (z = b, W = 1; d.charCodeAt(z + W) === tn;) W++;
...
`);
		...
		var To = q((b8, Ao) => {
			var Eo = Ri();
			Ao.exports = _g;
			var wo = 9, Co = 32, nn = 36, Ig = 48, qg = 57, yo = 92, Bg = ["math", "math-inline"], vo = "math-display";
			function _g(e) {
				let t = this.Parser, r = this.Compiler;
				Eo.isRemarkParser(t) && Pg(t, e), Eo.isRemarkCompiler(r) && Og(r, e);
			}
			function Pg(e, t) {
				...
				function u(i, o, s) {
					...
					if (o.charCodeAt(h) === yo && (f = !0, h++), o.charCodeAt(h) === nn) {
						if (h++, f) return s ? !0 : i(o.slice(0, h))({
							type: "text",
							value: "$"
						});
						if (o.charCodeAt(h) === nn && (c = !0, h++), x = o.charCodeAt(h), !(x === Co || x === wo)) {
							for (g = h; h < l;) {
								if (D = x, x = o.charCodeAt(h + 1), D === nn) {
									if (m = o.charCodeAt(h - 1), m !== Co && m !== wo && (x !== x || x < Ig || x > qg) && (!c || x === nn)) {
										k = h - 1, h++, c && h++, E = h;
										break;
									}
								} else D === yo && (h++, x = o.charCodeAt(h + 1));
								h++;
							}
							if (E !== void 0) return s ? !0 : (C = o.slice(g, k + 1), i(o.slice(0, E))({
								...
								data: {
									hName: "span",
									hProperties: { className: Bg.concat(c && t.inlineMathDouble ? [vo] : []) },
									hChildren: [{
										type: "text",
										value: C
									}]
			...
			function Og(e) {
				...
				function r(n) {
					let a = "$";
					return (n.data && n.data.hProperties && n.data.hProperties.className || []).includes(vo) && (a = "$$"), a + n.value + a;
				}
			}
		});
		var Bo = q((E8, qo) => {
			var So = Ri();
			qo.exports = zg;
			var Lo = 10, cr = 32, Mi = 36, Io = `
`, Ng = "$", Rg = 2, Mg = ["math", "math-display"];
			function zg() {
				let e = this.Parser, t = this.Compiler;
				So.isRemarkParser(e) && Ug(e), So.isRemarkCompiler(t) && Hg(t);
			}
			function Ug(e) {
				...
				function i(o, s, l) {
					...
					if (k = f - g, !(k < Rg)) {
						...
						if (s.charCodeAt(f) === Lo) {
							if (l) return !0;
							for (m = [], E !== f && m.push(s.slice(E, f)), f++, D = s.indexOf(Io, f + 1), D = D === -1 ? c : D; f < c;) {
								...
								f = D + 1, D = s.indexOf(Io, f + 1), D = D === -1 ? c : D;
							}
							return m = m.join(`
`), o(s.slice(0, D))({
								type: "math",
...
`,
		...
		var is = q((N8, ns) => {
			...
			function lx(e) {
				return sx.call(rs, e) ? rs[e] : !1;
			}
		});
		var fr = q((R8, gs) => {
			"use strict";
			var as = jo(), us = $o(), cx = bt(), fx = Jo(), cs = es(), px = is();
			gs.exports = yx;
			var hx = {}.hasOwnProperty, Nt = String.fromCharCode, mx = Function.prototype, os = {
				warning: null,
				reference: null,
				text: null,
				warningContext: null,
				...
				attribute: !1,
				nonTerminated: !0
			}, Dx = 9, ss = 10, dx = 12, gx = 32, ls = 38, xx = 59, kx = 60, Fx = 61, bx = 35, Ex = 88, wx = 120, Cx = 65533, Rt = "named", Vi = "hexadecimal", Gi = "decimal", Wi = {};
			Wi[Vi] = 16;
			Wi[Gi] = 10;
			var an = {};
			an[Rt] = cs;
			an[Gi] = cx;
			an[Vi] = fx;
			var fs = 1, ps = 2, hs = 3, ms = 4, Ds = 5, Hi = 6, ds = 7, at = {};
			at[fs] = "Named character references must be terminated by a semicolon";
			at[ps] = "Numeric character references must be terminated by a semicolon";
			at[hs] = "Named character references cannot be empty";
			at[ms] = "Numeric character references cannot be empty";
			at[Ds] = "Named character references must be known";
			...
			function vx(e, t) {
				...
				for (typeof r == "string" && (r = r.charCodeAt(0)), W = ie(), b = i ? F : mx, m--, h++; ++m < h;) if (v === ss && (x = f[D] || 1), v = e.charCodeAt(m), v === ls) {
					if (y = e.charCodeAt(m + 1), y === Dx || y === ss || y === dx || y === gx || y === ls || y === kx || y !== y || r && y === r) {
						k += Nt(v), x++;
						continue;
					}
					for (O = m + 1, R = O, Y = O, y === bx ? (Y = ++R, y = e.charCodeAt(Y), y === Ex || y === wx ? (z = Vi, Y = ++R) : z = Gi) : z = Rt, C = "", T = "", d = "", N = an[z], Y--; ++Y < h && (y = e.charCodeAt(Y), !!N(y));) d += Nt(y), z === Rt && hx.call(as, d) && (C = d, T = as[d]);
					w = e.charCodeAt(Y) === xx, w && (Y++, S = z === Rt ? px(d) : !1, S && (C = d, T = S)), p = 1 + Y - O, !w && !n || (d ? z === Rt ? (w && !T ? b(Ds, 1) : (C !== d && (Y = R + C.length, p = 1 + Y - R, w = !1), w || (_ = C ? fs : hs, t.attribute ? (y = e.charCodeAt(Y), y === Fx ? (b(_, p), T = null) : cs(y) ? T = null : b(_, p)) : b(_, p))), L = T) : (w || b(ps, p), L = parseInt(d, Wi[z]), Ax(L) ? (b(ds, p), L = Nt(Cx)) : L in us ? (b(Hi, p), L = us[L]) : (I = "", Tx(L) && b(Hi, p), L > 65535 && (L -= 65536, I += Nt(L >>> 10 | 55296), L = 56320 | L & 1023), L = I + Nt(L))) : z !== Rt && b(ms, p)), L ? (ee(), W = ie(), m = Y - 1, x += Y - O + 1, E.push(L), ne = ie(), ne.offset++, u && u.call(s, L, {
						start: W,
						end: ne
...
`, _ + 1);
					...
					function v(y, b) {
						...
						return I && y.type === I.type && (y.type === "text" || y.type === "blockquote") && bs(I) && bs(y) && (T = y.type === "text" ? qx : Bx, y = T.call(a, I, y)), y !== I && _.push(y), a.atStart && i.length !== 0 && a.exitStart(), y;
					}
					function L(y) {
						var b = E(), _ = d(), I = C();
...
`,
			...
			function un(e) {
				var t = e || {};
				return t.commonmark ? Cs : t.gfm ? ji : Yi;
			}
		});
		var Ts = q((H8, As) => {
			"use strict";
		...
		var _s = q((W8, Bs) => {
			...
			function Mx(e) {
				for (var t = [], r = -1; ++r < e.length;) t[r] = qs(e[r]);
				return n;
				function n() {
		...
		var zs = q((j8, Ms) => {
			"use strict";
			Ms.exports = on;
			var Vx = _s(), Gx = Os(), Ns = !0, Rs = "skip", Ki = !1;
			on.CONTINUE = Ns;
			on.SKIP = Rs;
			on.EXIT = Ki;
			function on(e, t, r, n) {
				...
				function i(o, s, l) {
					...
					function h() {
						...
						if (o.children && D[0] !== Rs) for (g = (n ? o.children.length : -1) + a; g > -1 && g < o.children.length;) {
			...
			function Wx(e) {
				return e !== null && typeof e == "object" && "length" in e ? e : typeof e == "number" ? [Ns, e] : [e];
			}
		});
		var Hs = q(($8, Us) => {
			"use strict";
			Us.exports = ln;
			var sn = zs(), Yx = sn.CONTINUE, jx = sn.SKIP, $x = sn.EXIT;
			ln.CONTINUE = Yx;
			ln.SKIP = jx;
			ln.EXIT = $x;
			function ln(e, t, r, n) {
...
`, Xs = "	", Zi = " ", c1 = o1(Zi, 4);
			function f1(e, t, r) {
				...
				else if (l === Xs) o += l, f = !0;
				else {
					for (c = ""; l === Xs || l === Zi;) c += l, l = t.charAt(++n);
					if (l !== Xi) break;
					o += c + l, s += l;
				}
				if (i) return r ? !0 : e(u)({
...
`, ul = "	", ta = " ", ol = ">";
			function F1(e, t, r) {
				for (var n = this, a = n.offset, u = n.blockTokenizers, i = n.interruptBlockquote, o = e.now(), s = o.line, l = t.length, c = [], f = [], h = [], m, D = 0, x, g, k, E, C, S, w, d; D < l && (x = t.charAt(D), !(x !== ta && x !== ul));) D++;
				if (t.charAt(D) === ol) {
					if (r) return !0;
					for (D = 0; D < l;) {
						for (k = t.indexOf(ea, D), S = D, w = !1, k === -1 && (k = l); D < l && (x = t.charAt(D), !(x !== ta && x !== ul));) D++;
						if (t.charAt(D) === ol ? (D++, w = !0, t.charAt(D) === ta && D++) : D = S, E = t.slice(D, k), !w && !x1(E)) {
							D = S;
							break;
						}
...
`, hr = "	", mr = " ", Dr = "#", b1 = 6;
			function E1(e, t, r) {
				...
				if (!(h > b1) && !(!h || !a && t.charAt(i + 1) === Dr)) {
					...
					if (!(!a && f.length === 0 && c && c !== cl)) {
						if (r) return !0;
						for (s += f, f = "", l = ""; ++i < u && (c = t.charAt(i), !(!c || c === cl));) {
							if (c !== mr && c !== hr && c !== Dr) {
								l += f + c, f = "";
								continue;
							}
...
`, hl = " ", y1 = "*", v1 = "-", A1 = "_", T1 = 3;
			function S1(e, t, r) {
				for (var n = -1, a = t.length + 1, u = "", i, o, s, l; ++n < a && (i = t.charAt(n), !(i !== w1 && i !== hl));) u += i;
		...
		var Fl = q((oT, kl) => {
			"use strict";
			var _1 = Et(), P1 = cn(), O1 = ra();
			kl.exports = M1;
			var xl = `
`, N1 = " ", R1 = "!";
			function M1(e, t) {
				var r = e.split(xl), n = r.length + 1, a = Infinity, u = [], i, o, s;
				...
				return r.shift(), r.join(xl);
			}
		});
		var vl = q((sT, yl) => {
			"use strict";
			var z1 = Et(), U1 = cn(), bl = bt(), H1 = ra(), V1 = Fl(), G1 = pn();
			yl.exports = X1;
			var na = "*", W1 = "_", El = "+", ia = "-", wl = ".", We = " ", _e = `
`, hn = "	", Cl = ")", Y1 = "x", ut = 4, j1 = /\n\n(?!\s*$)/, $1 = /^\[([ X\tx])][ \t]/, K1 = /^([ \t]*)([*+-]|\d+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/, Q1 = /^([ \t]*)([*+-]|\d+[.)])([ \t]+)/, J1 = /^( {1,4}|\t)?/gm;
			function X1(e, t, r) {
				for (var n = this, a = n.options.commonmark, u = n.options.pedantic, i = n.blockTokenizers, o = n.interruptList, s = 0, l = t.length, c = null, f, h, m, D, x, g, k, E, C, S, w, d, v, L, y, b, _, I, T, R = !1, O, z, N, W; s < l && (D = t.charAt(s), !(D !== hn && D !== We));) s++;
				if (D = t.charAt(s), D === na || D === El || D === ia) x = D, m = !1;
				else {
					for (m = !0, h = ""; s < l && (D = t.charAt(s), !!bl(D));) h += D, s++;
					if (D = t.charAt(s), !h || !(D === wl || a && D === Cl) || r && h !== "1") return;
					c = parseInt(h, 10), x = D;
				}
				if (D = t.charAt(++s), !(D !== We && D !== hn && (u || D !== _e && D !== ""))) {
					...
					for (s = 0, L = [], y = [], b = []; s < l;) {
						for (g = t.indexOf(_e, s), k = s, E = !1, W = !1, g === -1 && (g = l), f = 0; s < l;) {
							if (D = t.charAt(s), D === hn) f += ut - f % ut;
							else if (D === We) f++;
							else break;
							s++;
						}
						if (_ && f >= _.indent && (W = !0), D = t.charAt(s), C = null, !W) {
							if (D === na || D === El || D === ia) C = D, s++, f++;
							else {
								for (h = ""; s < l && (D = t.charAt(s), !!bl(D));) h += D, s++;
								D = t.charAt(s), s++, h && (D === wl || a && D === Cl) && (C = D, f += h.length + 1);
							}
							if (C) if (D = t.charAt(s), D === hn) f += ut - f % ut, s++;
							else if (D === We) {
...
`, rk = "	", Al = " ", Tl = "=", nk = "-", ik = 3, ak = 1, uk = 2;
			function ok(e, t, r) {
				...
				for (s = "", l = ""; ++i < u;) {
					...
					c === Al || c === rk ? l += c : (s += l + c, l = "");
				}
				if (a.column += o.length, a.offset += o.length, o += s + l, c = t.charAt(++i), f = t.charAt(++i), !(c !== aa || f !== Tl && f !== nk)) {
					for (o += c, l = f, h = f === Tl ? ak : uk; ++i < u;) {
						if (c = t.charAt(i), c !== f) {
							if (c !== aa) return;
							i--;
							break;
		...
		var oa = q((ua) => {
			"use strict";
			var Il = "<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^\"'=<>`\\u0000-\\u0020]+|'[^']*'|\"[^\"]*\"))?)*\\s*\\/?>", ql = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", mk = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->", Dk = "<[?].*?[?]>", dk = "<![A-Za-z]+\\s+[^>]*>", gk = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>";
			ua.openCloseTag = new RegExp("^(?:" + Il + "|" + ql + ")");
			ua.tag = new RegExp("^(?:" + Il + "|" + ql + "|" + mk + "|" + Dk + "|" + dk + "|" + gk + ")");
		});
		var Ol = q((fT, Pl) => {
			"use strict";
			...
			Pl.exports = Bk;
			var kk = "	", Fk = " ", Bl = `
`, bk = "<", Ek = /^<(script|pre|style)(?=(\s|>|$))/i, wk = /<\/(script|pre|style)>/i, Ck = /^<!--/, yk = /-->/, vk = /^<\?/, Ak = /\?>/, Tk = /^<![A-Za-z]/, Sk = />/, Lk = /^<!\[CDATA\[/, Ik = /]]>/, _l = /^$/, qk = new RegExp(xk.source + "\\s*$");
			function Bk(e, t, r) {
				...
				if (t.charAt(o) === bk) {
					for (s = t.indexOf(Bl, o + 1), s = s === -1 ? i : s, l = t.slice(o, s), c = -1, h = x.length; ++c < h;) if (x[c][0].test(l)) {
						m = x[c];
						break;
					}
					if (m) {
						...
						if (o = s, !m[1].test(l)) for (; o < i;) {
							if (s = t.indexOf(Bl, o + 1), s = s === -1 ? i : s, l = t.slice(o + 1, s), m[1].test(l)) {
								l && (o = s);
								break;
							}
							o = s;
		...
		var Yl = q((DT, Wl) => {
			...
			Wl.exports = Wk;
			var zl = "\"", Ul = "'", Hk = "\\", Ut = `
`, Dn = "	", dn = " ", ca = "[", dr = "]", Vk = "(", Gk = ")", Hl = ":", Vl = "<", Gl = ">";
			function Wk(e, t, r) {
				for (var n = this, a = n.options.commonmark, u = 0, i = t.length, o = "", s, l, c, f, h, m, D, x; u < i && (f = t.charAt(u), !(f !== dn && f !== Dn));) o += f, u++;
				if (f = t.charAt(u), f === ca) {
					for (u++, o += f, c = ""; u < i && (f = t.charAt(u), f !== dr);) f === Hk && (c += f, u++, f = t.charAt(u)), c += f, u++;
					if (!(!c || t.charAt(u) !== dr || t.charAt(u + 1) !== Hl)) {
						for (m = c, o += c + dr + Hl, u = o.length, c = ""; u < i && (f = t.charAt(u), !(f !== Dn && f !== dn && f !== Ut));) o += f, u++;
						if (f = t.charAt(u), c = "", s = o, f === Vl) {
							for (u++; u < i && (f = t.charAt(u), !!la(f));) c += f, u++;
							if (f = t.charAt(u), f === la.delimiter) o += Vl + c + f, u++;
							else {
								if (a) return;
								u -= c.length + 1, c = "";
							}
						...
						if (c) {
							for (D = c, c = ""; u < i && (f = t.charAt(u), !(f !== Dn && f !== dn && f !== Ut));) c += f, u++;
							if (f = t.charAt(u), h = null, f === zl ? h = zl : f === Ul ? h = Ul : f === Vk && (h = Gk), !h) c = "", u = o.length;
							else if (c) {
							...
							for (; u < i && (f = t.charAt(u), !(f !== Dn && f !== dn));) o += f, u++;
		...
		var Kl = q((dT, $l) => {
			...
			$l.exports = n0;
			var $k = "	", gn = `
`, Kk = " ", Qk = "-", Jk = ":", Xk = "\\", fa = "|", Zk = 1, e0 = 2, jl = "left", t0 = "center", r0 = "right";
			function n0(e, t, r) {
				...
				if (n.options.gfm) {
					...
					for (o = c.join(gn), u = c.splice(1, 1)[0] || [], a = 0, l = u.length, C--, i = !1, D = []; a < l;) {
						...
						else if (h === Jk) i === jl ? i = t0 : m && i === null ? i = r0 : i = jl;
						else if (!jk(h)) return;
						a++;
					}
					if (i !== !1 && D.push(i), !(D.length < Zk)) {
						...
						for (E = -1, w = [], d = e(o).reset({
							...
							for (S = c[E], s = {
								type: "tableRow",
								children: []
							}, E && e(gn), e(S).reset(s, d), l = S.length + 1, a = 0, f = "", x = "", g = !0; a < l;) {
...
`, tc = "\\";
			function rc(e, t, r) {
				var n = this, a, u;
				if (t.charAt(0) === tc && (a = t.charAt(1), n.escape.indexOf(a) !== -1)) return r ? !0 : (a === p0 ? u = { type: "break" } : u = {
					type: "text",
					value: a
				}, e(tc + a)(u));
			}
		...
		var cc = q((bT, lc) => {
			"use strict";
			var uc = Pe(), m0 = fr(), D0 = pa();
			lc.exports = da;
			da.locator = D0;
			da.notInLink = !0;
			var oc = "<", ha = ">", sc = "@", ma = "/", Da = "mailto:", xn = Da.length;
			function da(e, t, r) {
				var n = this, a = "", u = t.length, i = 0, o = "", s = !1, l = "", c, f, h, m, D;
				if (t.charAt(0) === oc) {
					for (i++, a = oc; i < u && (c = t.charAt(i), !(uc(c) || c === ha || c === sc || c === ":" && t.charAt(i + 1) === ma));) o += c, i++;
					if (o) {
						if (l += o, o = "", c = t.charAt(i), l += c, i++, c === sc) s = !0;
						else {
							if (c !== ":" || t.charAt(i + 1) !== ma) return;
							l += ma, i++;
						}
						for (; i < u && (c = t.charAt(i), !(uc(c) || c === ha));) o += c, i++;
						if (c = t.charAt(i), !(!o || c !== ha)) return r ? !0 : (l += o, h = l, a += l + c, f = e.now(), f.column++, f.offset++, s && (l.slice(0, xn).toLowerCase() === Da ? (h = h.slice(xn), f.column += xn, f.offset += xn) : l = Da + l), m = n.inlineTokenizers, n.inlineTokenizers = { text: m.text }, D = n.enterLink(), h = n.tokenizeInline(h, f), n.inlineTokenizers = m, D(), e(a)({
							type: "link",
							title: null,
		...
		var Dc = q((wT, mc) => {
			...
			function g0(e, t) {
				...
				for (a = hc.length, n = -1; ++n < a;) u = e.indexOf(hc[n], t), u !== -1 && (r === -1 || u < r) && (r = u);
				return r;
			}
		});
		var Fc = q((CT, kc) => {
			"use strict";
			var dc = pc(), x0 = fr(), k0 = bt(), ga = Ot(), F0 = Pe(), b0 = Dc();
			kc.exports = ka;
			ka.locator = b0;
			ka.notInLink = !0;
			var E0 = 33, w0 = 38, C0 = 41, y0 = 42, v0 = 44, A0 = 45, xa = 46, T0 = 58, S0 = 59, L0 = 63, I0 = 60, gc = 95, q0 = 126, B0 = "(", xc = ")";
			function ka(e, t, r) {
				...
				if (a) {
					...
					if (x === xa && (l.pop(), h--), l[0] !== void 0 && (c = l.length < 2 ? f : l[l.length - 2] + 1, t.slice(c, h).indexOf("_") === -1)) {
						if (r) return !0;
						for (g = h, m = h; h < i && (x = t.charCodeAt(h), !(F0(x) || x === I0));) h++, x === E0 || x === y0 || x === v0 || x === xa || x === T0 || x === L0 || x === gc || x === q0 || (g = h);
						if (h = g, t.charCodeAt(h - 1) === C0) for (D = t.slice(m, h), k = dc(D, B0), E = dc(D, xc); E > k;) h = m + D.lastIndexOf(xc), D = t.slice(m, h), E--;
		...
		var Cc = q((yT, wc) => {
			...
			function Ec(e, t) {
				...
				if (a = n, a === t || !bc(e.charCodeAt(a - 1))) return Ec.call(r, e, n + 1);
				for (; a > t && bc(e.charCodeAt(a - 1));) a--;
				return a;
			}
			function bc(e) {
		...
		var Tc = q((vT, Ac) => {
			"use strict";
			var z0 = fr(), yc = bt(), vc = Ot(), U0 = Cc();
			Ac.exports = Ea;
			Ea.locator = U0;
			Ea.notInLink = !0;
			var H0 = 43, Fa = 45, kn = 46, V0 = 64, ba = 95;
			function Ea(e, t, r) {
				var n = this, a = n.options.gfm, u = n.inlineTokenizers, i = 0, o = t.length, s = -1, l, c, f, h;
				if (a) {
					for (l = t.charCodeAt(i); yc(l) || vc(l) || l === H0 || l === Fa || l === kn || l === ba;) l = t.charCodeAt(++i);
					if (i !== 0 && l === V0) {
						for (i++; i < o;) {
							if (l = t.charCodeAt(i), yc(l) || vc(l) || l === Fa || l === kn || l === ba) {
								i++, s === -1 && l === kn && (s = i);
								continue;
							}
							break;
						}
						if (!(s === -1 || s === i || l === Fa || l === ba)) return l === kn && i--, c = t.slice(0, i), r ? !0 : (h = n.enterLink(), n.inlineTokenizers = { text: u.text }, f = n.tokenizeInline(c, e.now()), n.inlineTokenizers = u, h(), e(c)({
							type: "link",
							title: null,
		...
		var Mc = q((ST, Rc) => {
			...
			Nc.locator = eF;
			var tF = `
`, rF = "!", Bc = "\"", _c = "'", Ht = "(", kr = ")", Ca = "<", ya = ">", Pc = "[", Fr = "\\", nF = "]", Oc = "`";
			function Nc(e, t, r) {
				...
				if (i === rF && (k = !0, a = i, i = t.charAt(++u)), i === Pc && !(!k && n.inLink)) {
					for (a += i, v = "", u++, S = t.length, y = e.now(), d = 0, y.column += u, y.offset += u; u < S;) {
						if (i = t.charAt(u), x = i, i === Oc) {
							for (f = 1; t.charAt(u + 1) === Oc;) x += i, u++, f++;
							h ? f >= h && (h = 0) : h = f;
					...
					if (c) {
						...
						if (i = t.charAt(u), v = "", m = a, i === Ca) {
							...
							for (i = null, x = ""; u < S && (i = t.charAt(u), !(x && (i === Bc || i === _c || s && i === Ht)));) {
								if (xr(i)) {
									if (!o) break;
									x += i;
								} else {
						...
						if (i = t.charAt(u), a += v, v && (i === Bc || i === _c || s && i === Ht)) if (u++, a += i, v = "", C = i === Ht ? kr : i, D = a, s) {
		...
		var Hc = q((LT, Uc) => {
			...
			Uc.exports = zc;
			zc.locator = aF;
			var va = "link", oF = "image", sF = "shortcut", lF = "collapsed", Aa = "full", cF = "!", Fn = "[", bn = "\\", En = "]";
			function zc(e, t, r) {
				var n = this, a = n.options.commonmark, u = t.charAt(0), i = 0, o = t.length, s = "", l = "", c = va, f = sF, h, m, D, x, g, k, E, C;
				if (u === cF && (c = oF, l = u, u = t.charAt(++i)), u === Fn) {
					for (i++, l += u, k = "", C = 0; i < o;) {
						if (u = t.charAt(i), u === Fn) E = !0, C++;
						else if (u === En) {
							if (!C) break;
							C--;
						}
					...
					if (s = k, h = k, u = t.charAt(i), u === En) {
						if (i++, s += u, k = "", !a) for (; i < o && (u = t.charAt(i), !!iF(u));) k += u, i++;
						if (u = t.charAt(i), u === Fn) {
							for (m = "", k += u, i++; i < o && (u = t.charAt(i), !(u === Fn || u === En));) u === bn && (m += bn, u = t.charAt(++i)), m += u, i++;
							u = t.charAt(i), u === En ? (f = m ? Aa : lF, k += m + u, i++) : m = "", s += k, k = "";
						} else {
							if (!h) return;
							m = h;
						}
		...
		var $c = q((qT, jc) => {
			"use strict";
			var pF = Et(), Wc = Pe(), hF = Gc();
			jc.exports = Yc;
			Yc.locator = hF;
			var mF = "\\", DF = "*", dF = "_";
			function Yc(e, t, r) {
				var n = this, a = 0, u = t.charAt(a), i, o, s, l, c, f, h;
				if (!(u !== DF && u !== dF || t.charAt(++a) !== u) && (o = n.options.pedantic, s = u, c = s + s, f = t.length, a++, l = "", u = "", !(o && Wc(t.charAt(a))))) for (; a < f;) {
					if (h = u, u = t.charAt(a), u === s && t.charAt(a + 1) === s && (!o || !Wc(h)) && (u = t.charAt(a + 2), u !== s)) return pF(l) ? r ? !0 : (i = e.now(), i.column += 2, i.offset += 2, e(c + l + c)({
						type: "strong",
		...
		var nf = q((PT, rf) => {
			"use strict";
			var bF = Et(), EF = Qc(), Zc = Pe(), wF = Xc();
			rf.exports = tf;
			tf.locator = wF;
			var CF = "*", ef = "_", yF = "\\";
			function tf(e, t, r) {
				var n = this, a = 0, u = t.charAt(a), i, o, s, l, c, f, h;
				if (!(u !== CF && u !== ef) && (o = n.options.pedantic, c = u, s = u, f = t.length, a++, l = "", u = "", !(o && Zc(t.charAt(a))))) for (; a < f;) {
					if (h = u, u = t.charAt(a), u === s && (!o || !Zc(h))) {
						if (u = t.charAt(++a), u !== s) {
							if (!bF(l) || h === s) return;
							if (!o && s === ef && EF(u)) {
								l += s;
		...
		var ff = q((NT, cf) => {
			...
			function lf(e, t, r) {
				...
				if (!(!n.options.gfm || t.charAt(0) !== wn || t.charAt(1) !== wn || of(t.charAt(2)))) for (s = 1, l = t.length, c = e.now(), c.column += 2, c.offset += 2; ++s < l;) {
					if (a = t.charAt(s), a === wn && u === wn && (!i || !of(i))) return r ? !0 : e(sf + o + sf)({
						type: "delete",
...
`, _F = 2;
		...
		var Af = q((VT, vf) => {
			"use strict";
			var OF = Ft(), Cn = Ho(), NF = Go(), RF = Yo(), MF = Fs(), Ia = ws();
			vf.exports = Cf;
			function Cf(e, t) {
			...
			ue.blockMethods = yf(ue.blockTokenizers);
			ue.inlineMethods = yf(ue.inlineTokenizers);
		...
		var If = q((GT, Lf) => {
			"use strict";
			var zF = zo(), UF = Ft(), Tf = Af();
			Lf.exports = Sf;
			Sf.Parser = Tf;
			function Sf(e) {
				var t = this.data("settings"), r = zF(Tf);
		...
		var qa = q((YT, _f) => {
			_f.exports = function(t) {
				return t != null && t.constructor != null && typeof t.constructor.isBuffer == "function" && t.constructor.isBuffer(t);
			};
		});
		var Vf = q((jT, Hf) => {
			"use strict";
			var yn = Object.prototype.hasOwnProperty, Uf = Object.prototype.toString, Pf = Object.defineProperty, Of = Object.getOwnPropertyDescriptor, Nf = function(t) {
				return typeof Array.isArray == "function" ? Array.isArray(t) : Uf.call(t) === "[object Array]";
			}, Rf = function(t) {
				if (!t || Uf.call(t) !== "[object Object]") return !1;
				...
				Pf && r.name === "__proto__" ? Pf(t, r.name, {
					enumerable: !0,
					configurable: !0,
					value: r.newValue,
					writable: !0
				...
				if (r === "__proto__") if (yn.call(t, r)) {
					if (Of) return Of(t, r).value;
				} else return;
				return t[r];
			};
			Hf.exports = function e() {
				var t, r, n, a, u, i, o = arguments[0], s = 1, l = arguments.length, c = !1;
				for (typeof o == "boolean" && (c = o, o = arguments[1] || {}, s = 2), (o == null || typeof o != "object" && typeof o != "function") && (o = {}); s < l; ++s) if (t = arguments[s], t != null) for (r in t) n = zf(o, r), a = zf(t, r), o !== a && (c && a && (Rf(a) || (u = Nf(a))) ? (u ? (u = !1, i = n && Nf(n) ? n : []) : i = n && Rf(n) ? n : {}, Mf(o, {
					name: r,
					newValue: e(c, i, a)
				})) : typeof a < "u" && Mf(o, {
					name: r,
		...
		var Xf = q((QT, Jf) => {
			...
			function Qf() {
				...
				function r() {
					var a = -1, u = $f.call(arguments, 0, -1), i = arguments[arguments.length - 1];
					if (typeof i != "function") throw new Error("Expected function as last argument, not " + i);
					o.apply(null, [null].concat(u));
					function o(s) {
						var l = e[++a], f = $f.call(arguments, 0).slice(1), h = u.length, m = -1;
						if (s) {
							i(s);
							return;
						}
						for (; ++m < h;) (f[m] === null || f[m] === void 0) && (f[m] = u[m]);
						u = f, l ? Kf(l, o).apply(null, u) : i.apply(null, [null].concat(u));
					}
				}
				function n(a) {
		...
		var rp = q((JT, tp) => {
			...
			tp.exports = WF;
			function WF(e) {
				return !e || typeof e != "object" ? "" : Vt.call(e, "position") || Vt.call(e, "type") ? Zf(e.position) : Vt.call(e, "start") || Vt.call(e, "end") ? Zf(e) : Vt.call(e, "line") || Vt.call(e, "column") ? Ba(e) : "";
			}
			function Ba(e) {
				return (!e || typeof e != "object") && (e = {}), ep(e.line) + ":" + ep(e.column);
			}
			function Zf(e) {
		...
		var fp = q((t3, cp) => {
			...
			function ob(e) {
				lp(this.path, "dirname"), this.path = Oe.join(e || "", this.basename);
			}
			function sb() {
			...
			function fb(e) {
				if (Oa(e, "extname"), lp(this.path, "extname"), e) {
		...
		var hp = q((r3, pp) => {
			...
			var Db = ap(), vn = fp();
			pp.exports = vn;
			vn.prototype.message = db;
			vn.prototype.info = xb;
			vn.prototype.fail = gb;
			function db(e, t, r) {
				var n = new Db(e, t, r);
		...
		var Cp = q((i3, wp) => {
			"use strict";
			var dp = Bf(), kb = qa(), An = Vf(), gp = Wf(), bp = Xf(), Er = Dp();
			wp.exports = Ep().freeze();
			var Fb = [].slice, bb = {}.hasOwnProperty, Eb = bp().use(wb).use(Cb).use(yb);
			function wb(e, t) {
			...
			function Ep() {
				...
				function u() {
					for (var g = Ep(), k = -1; ++k < e.length;) g.use.apply(null, e[k]);
				...
				function s(g) {
					...
					function E(d) {
						S(d.plugins), d.settings && (k = An(k || {}, d.settings));
					}
					function C(d) {
					...
					function w(d, v) {
						var L = l(d);
						L ? (gp(L[1]) && gp(v) && (v = An(!0, L[1], v)), L[1] = v) : e.push(Fb.call(arguments));
					}
				}
				function l(g) {
				...
				function c(g) {
					var k = Er(g), E;
					return i(), E = u.Parser, Ra("parse", E), xp(E, "parse") ? new E(String(k), k).parse() : E(String(k), k);
				}
				function f(g, k, E) {
					if (kp(g), i(), !E && typeof k == "function" && (E = k, k = null), !E) return new Promise(C);
					C(null, E);
					function C(S, w) {
						t.run(g, Er(k), d);
						function d(v, L, y) {
				...
				function h(g, k) {
					var E, C;
					return f(g, k, S), Fp("runSync", "run", C), E;
					function S(w, d) {
						C = !0, E = d, dp(w);
					}
				}
				function m(g, k) {
					var E = Er(k), C;
					return i(), C = u.Compiler, Ma("stringify", C), kp(g), xp(C, "compile") ? new C(g, E).compile() : C(g, E);
				}
				function D(g, k) {
				...
				function x(g) {
					var k, E;
					return i(), Ra("processSync", u.Parser), Ma("processSync", u.Compiler), k = Er(g), D(k, C), Fp("processSync", "process", E), k;
					function C(S) {
						E = !0, dp(S);
					}
				}
		...
		var pt = (e) => e.position.start.offset, ht = (e) => e.position.end.offset;
		...
		function Yn(e = {}) {
			...
			return { text: { 91: { tokenize: (i, o, s) => {
				...
				function k(w) {
					return w === r.charCodeAt(f) ? l ? (i.exit("wikiLinkTarget"), i.enter("wikiLinkAliasMarker"), E(w)) : s(w) : w === a.charCodeAt(m) ? l ? (i.exit("wikiLinkTarget"), i.exit("wikiLinkData"), i.enter("wikiLinkMarker"), S(w)) : s(w) : Wn(w) || w === tt.eof ? s(w) : (bu(w) || (l = !0), i.consume(w), k);
				}
				function E(w) {
					return f === r.length ? (i.exit("wikiLinkAliasMarker"), i.enter("wikiLinkAlias"), C(w)) : w !== r.charCodeAt(f) ? s(w) : (i.consume(w), f++, E);
				}
				function C(w) {
					return w === a.charCodeAt(m) ? c ? (i.exit("wikiLinkAlias"), i.exit("wikiLinkData"), i.enter("wikiLinkMarker"), S(w)) : s(w) : Wn(w) || w === tt.eof ? s(w) : (bu(w) || (c = !0), i.consume(w), C);
				}
				function S(w) {
		...
		function jn(e, t) {
			let r = t || Dm;
			return wu(e, typeof r.includeImageAlt == "boolean" ? r.includeImageAlt : !0, typeof r.includeHtml == "boolean" ? r.includeHtml : !0);
		}
		function wu(e, t, r) {
			if (dm(e)) {
				if ("value" in e) return e.type === "html" && !r ? "" : e.value;
				if (t && "alt" in e && e.alt) return e.alt;
				if ("children" in e) return Eu(e.children, t, r);
			}
			return Array.isArray(e) ? Eu(e, t, r) : "";
		}
		function Eu(e, t, r) {
			let n = [], a = -1;
			for (; ++a < e.length;) n[a] = wu(e[a], t, r);
			return n.join("");
		}
		function dm(e) {
...
`,
		...
		function xm(e, t) {
			let r;
			for (r in t) {
				let a = (Cu.call(e, r) ? e[r] : void 0) || (e[r] = {}), u = t[r], i;
				if (u) for (i in u) {
					Cu.call(a, i) || (a[i] = []);
					let o = u[i];
		...
		var K = rt(/[A-Za-z]/), Q = rt(/[\dA-Za-z]/), yu = rt(/[#-'*+\--9=?A-Z^-~]/);
		function mt(e) {
			return e !== null && (e < 32 || e === 127);
		}
		var er = rt(/\d/), vu = rt(/[\dA-Fa-f]/), Au = rt(/[!-/:-@[-`{-~]/);
		function B(e) {
			return e !== null && e < -2;
		}
		function G(e) {
		...
		var Lu = { tokenize: bm }, Su = { tokenize: Em };
		function bm(e) {
			...
			function l(C) {
				...
				return t.containerState = {}, e.check(Su, c, f)(C);
			}
			function c(C) {
				return a && E(), k(n), h(C);
			}
			...
			function h(C) {
				return t.containerState = {}, e.attempt(Su, m, D)(C);
			}
			function m(C) {
		...
		function ym(e, t, r) {
			...
			function l(m) {
				return m === 64 ? (e.consume(m), c) : yu(m) ? (e.consume(m), l) : r(m);
			}
			function c(m) {
				return Q(m) ? f(m) : r(m);
			}
		...
		function Lm(e, t, r) {
			...
			function a(u) {
				return Au(u) ? (e.enter("characterEscapeValue"), e.consume(u), e.exit("characterEscapeValue"), e.exit("characterEscape"), t) : r(u);
			}
		}
		var Ur = {
		...
		function Im(e, t, r) {
			...
			function l(f) {
				return f === 88 || f === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(f), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), u = 6, i = vu, c) : (e.enter("characterReferenceValue"), u = 7, i = er, c(f));
			}
			function c(f) {
				if (f === 59 && a) {
		...
		function qm(e, t, r) {
			...
			function f(d) {
				return d === null || B(d) ? (e.exit("codeFencedFence"), n.interrupt ? t(d) : e.check(qu, x, S)(d)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), h(d));
			}
			function h(d) {
			...
			function E(d) {
				return d === null || B(d) ? e.check(qu, x, S)(d) : (e.enter("codeFlowValue"), C(d));
			}
			function C(d) {
		...
		function Gr(e) {
			let t = {}, r = -1, n, a, u, i, o, s, l, c = new Vr(e);
			for (; ++r < c.length;) {
				for (; r in t;) r = t[r];
		...
		function Ym(e, t, r) {
			...
			function l(m) {
				return Wr(e, c, r, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(m);
			}
			function c(m) {
		...
		function eD(e, t, r) {
			...
			function g(F) {
				if (F === null || F === 47 || F === 62 || G(F)) {
					...
					return !ee && !u && ti.includes(ce) ? (a = 1, n.interrupt ? t(F) : I(F)) : Bu.includes(i.toLowerCase()) ? (a = 6, ee ? (e.consume(F), k) : n.interrupt ? t(F) : I(F)) : (a = 7, n.interrupt && !n.parser.lazy[n.now().line] ? r(F) : u ? E(F) : C(F));
				}
		...
		var gt = {
			...
			resolveTo: sD,
			tokenize: lD
		}, iD = { tokenize: cD }, aD = { tokenize: fD }, uD = { tokenize: pD };
		function oD(e) {
			let t = -1, r = [];
			for (; ++t < e.length;) {
				let n = e[t][1];
		...
		function cD(e, t, r) {
			...
			function u(f) {
				return f === 41 ? c(f) : Wr(e, i, o, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(f);
			}
			function i(f) {
			...
			function s(f) {
				return f === 34 || f === 39 || f === 40 ? jr(e, l, r, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(f) : c(f);
			}
			function l(f) {
		...
		var Pu = { resolveAll: Mu() }, Ou = Ru("string"), Nu = Ru("text");
		function Ru(e) {
			return {
				resolveAll: Mu(e === "text" ? AD : void 0),
				tokenize: t
			};
			function t(r) {
		...
		var TD = {
			...
			95: tr,
			96: Qn
		}, _D = { null: [tr, Pu] }, PD = { null: [42, 95] }, OD = { null: [] };
		function zu(e, t, r) {
			let n = {
				_bufferIndex: -1,
				_index: 0,
...
`;
		...
		function li() {
			...
			function a(u, i, o) {
				...
				for (u = t + (typeof u == "string" ? u.toString() : new TextDecoder(i || void 0).decode(u)), f = 0, t = "", r && (u.charCodeAt(0) === 65279 && f++, r = void 0); f < u.length;) {
					if (Uu.lastIndex = f, l = Uu.exec(u), h = l && l.index !== void 0 ? l.index : u.length, m = u.charCodeAt(h), !l) {
						t = u.slice(f);
						break;
					}
		...
		var MD = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
		function Hu(e) {
		...
		function Lt(e) {
			return !e || typeof e != "object" ? "" : "position" in e || "type" in e ? Vu(e.position) : "start" in e || "end" in e ? Vu(e) : "line" in e || "column" in e ? ci(e) : "";
		}
		function ci(e) {
		...
		function UD(e) {
			...
			function n(A) {
				...
				for ($ = -1; ++$ < A.length;) {
					let ye = t[A[$][0]];
					Yu.call(ye, A[$][1].type) && ye[A[$][1].type].call(Object.assign({ sliceSerialize: A[$][2].sliceSerialize }, V), A[$][1]);
				}
				if (V.tokenStack.length > 0) {
					let ye = V.tokenStack[V.tokenStack.length - 1];
					(ye[1] || Wu).call(V, void 0, ye[0]);
				}
				for (P.position = {
			...
			function l(A, P) {
				...
				if (j) j[0].type !== A.type && (P ? P.call(this, A, j[0]) : (j[1] || Wu).call(this, A, j[0]));
			...
			function W(A) {
				...
				V.label = Hu(P), V.identifier = fe(P).toLowerCase();
			}
			function ne() {
			...
			function te(A) {
				...
				V ? (j = Rr(P, V === "characterReferenceMarkerNumeric" ? 10 : 16), this.data.characterReferenceType = void 0) : j = Tt(P);
		...
		function ju(e, t) {
			...
			for (; ++r < t.length;) {
				let n = t[r];
				Array.isArray(n) ? ju(e, n) : HD(e, n);
			}
		}
		function HD(e, t) {
			let r;
			for (r in t) if (Yu.call(t, r)) switch (r) {
				case "canContainEols": {
					let n = t[r];
					n && e[r].push(...n);
					break;
		...
		function WD(e, t, r) {
			...
			return i;
			function i(f) {
				return !hi(f) || !to.call(n, n.previous) || Di(n.events) ? r(f) : (e.enter("literalAutolink"), e.enter("literalAutolinkEmail"), o(f));
			}
			function o(f) {
		...
		function YD(e, t, r) {
			...
			return a;
			function a(i) {
				return i !== 87 && i !== 119 || !Zu.call(n, n.previous) || Di(n.events) ? r(i) : (e.enter("literalAutolink"), e.enter("literalAutolinkWww"), e.check(VD, e.attempt($u, e.attempt(Ku, u), r), r)(i));
			}
			function u(i) {
		...
		function jD(e, t, r) {
			...
			return i;
			function i(f) {
				return (f === 72 || f === 104) && eo.call(n, n.previous) && !Di(n.events) ? (e.enter("literalAutolink"), e.enter("literalAutolinkHttp"), a += String.fromCodePoint(f), e.consume(f), o) : r(f);
			}
			function o(f) {
			...
			function l(f) {
				return f === null || mt(f) || G(f) || Ie(f) || Dt(f) ? r(f) : e.attempt($u, e.attempt(Ku, c), r)(f);
			}
			function c(f) {
		...
		function KD(e, t, r) {
			...
			return i;
			function i(l) {
				return l === 46 || l === 95 ? e.check(Qu, s, o)(l) : l === null || G(l) || Ie(l) || l !== 45 && Dt(l) ? s(l) : (u = !0, e.consume(l), i);
			}
			function o(l) {
		...
		function QD(e, t) {
			...
			return a;
			function a(i) {
				return i === 40 ? (r++, e.consume(i), a) : i === 41 && n < r ? u(i) : i === 33 || i === 34 || i === 38 || i === 39 || i === 41 || i === 42 || i === 44 || i === 46 || i === 58 || i === 59 || i === 60 || i === 63 || i === 93 || i === 95 || i === 126 ? e.check(Qu, t, u)(i) : i === null || G(i) || Ie(i) ? t(i) : (e.consume(i), a);
			}
			function u(i) {
		...
		function ld(e, t) {
			let r = -1, n = !0, a = 0, u = [
				...
				0,
				0
			], o = !1, s = 0, l, c, f, h = new Kr();
			for (; ++r < e.length;) {
				let m = e[r], D = m[1];
				m[0] === "enter" ? D.type === "tableHead" ? (o = !1, s !== 0 && (no(h, t, s, l, c), c = void 0, s = 0), l = {
					type: "table",
					...
					c,
					t
				]])), a = D.type === "tableDelimiterRow" ? 2 : c ? 3 : 1) : a && (D.type === "data" || D.type === "tableDelimiterMarker" || D.type === "tableDelimiterFiller") ? (n = !1, i[2] === 0 && (u[1] !== 0 && (i[0] = i[1], f = Qr(h, t, u, a, void 0, f), u = [
					0,
					0,
					0,
					0
				]), i[2] = r)) : D.type === "tableCellDivider" && (n ? n = !1 : (u[1] !== 0 && (i[0] = i[1], f = Qr(h, t, u, a, void 0, f)), u = i, i = [
					u[1],
					r,
					0,
					0
				])) : D.type === "tableHead" ? (o = !0, s = r) : D.type === "tableRow" || D.type === "tableDelimiterRow" ? (s = r, u[1] !== 0 ? (i[0] = i[1], f = Qr(h, t, u, a, r, f)) : i[1] !== 0 && (f = Qr(h, t, i, a, r, f)), a = 0) : a && (D.type === "data" || D.type === "tableDelimiterMarker" || D.type === "tableDelimiterFiller") && (i[3] = r);
			}
			for (s !== 0 && no(h, t, s, l, c), h.consume(t.events), r = -1; ++r < t.events.length;) {
				let m = t.events[r];
		...
		function hd(e, t, r) {
			...
			function f(E) {
				return e.exit("mathFlowFence"), n.interrupt ? t(E) : e.attempt(ao, h, g)(E);
			}
			function h(E) {
				return e.attempt({
					tokenize: k,
			...
			function D(E) {
				return E === null ? g(E) : B(E) ? e.attempt(ao, h, g)(E) : (e.enter("mathFlowValue"), x(E));
			}
			function x(E) {
		...
		var qt = (e, t) => (r, n, ...a) => r | 1 && n == null ? void 0 : (t.call(n) ?? n[e]).apply(n, a);
		function gd(e) {
			return this[e < 0 ? this.length + e : e];
		}
		var J = qt("at", function() {
			if (Array.isArray(this) || typeof this == "string") return gd;
		});
		var kd = String.prototype.replaceAll ?? function(e, t) {
		...
		var so = Ed;
		var Jr = Symbol.for("PRETTIER_IS_FRONT_MATTER");
		var ur = 3;
		function wd(e) {
			let t = e.slice(0, ur);
			if (t !== "---" && t !== "+++") return;
...
`)), J(0, l, -1).length;
			...
			function o(s, l, c) {
				...
				function h() {
					...
					if ("children" in s && s.children) {
						let k = s;
						if (k.children && m[0] !== fo) for (x = (n ? k.children.length : -1) + i, g = c.concat(k); x > -1 && x < k.children.length;) {
							let E = k.children[x];
		...
		function Ld(e) {
			return Array.isArray(e) ? e : typeof e == "number" ? [co, e] : e == null ? lo : [e];
		}
		function Ci(e, t, r) {
		...
		function zd(e, t, r, n, a) {
			let u = "";
			if (!po(a) || (/^w/i.test(t) && (r = t + r, t = "", u = "http://"), !Hd(r))) return !1;
			let i = Vd(r + n);
			if (!i[0]) return !1;
			let o = {
				type: "link",
		...
		function Ii() {
			return { exit: {
				taskListCheckValueChecked: mo,
				taskListCheckValueUnchecked: mo,
				paragraph: hg
			} };
		}
		function mo(e) {
		...
		var fh = At(bo(), 1), ph = At(Po(), 1), hh = At(If(), 1), mh = At(Cp(), 1);
		var Ab = /^import\s/, Tb = /^export\s/, yp = "[a-z][a-z0-9]*(\\.[a-z][a-z0-9]*)*|", vp = /<!---->|<!---?[^>-](?:-?[^-])*-->/, Sb = /^\{\s*\/\*(.*)\*\/\s*\}/;
		var Lb = (e) => Ab.test(e), Ap = (e) => Tb.test(e), Tp = (e) => Lb(e) || Ap(e), Ua = (e, t) => {
			let r = t.indexOf(`

`), n = r === -1 ? t : t.slice(0, r);
			if (Tp(n)) return e(n)({
				type: Ap(n) ? "export" : "import",
				value: n
			});
		};
		Ua.notInBlock = !0;
		Ua.locator = (e) => Tp(e) ? -1 : 1;
		var Sp = (e, t) => {
			let r = Sb.exec(t);
			if (r) return e(r[0])({
				type: "esComment",
		...
		Sp.locator = (e, t) => e.indexOf("{", t);
		var Lp = function() {
			let { Parser: e } = this, { blockTokenizers: t, blockMethods: r, inlineTokenizers: n, inlineMethods: a } = e.prototype;
			t.esSyntax = Ua, n.esComment = Sp, r.splice(r.indexOf("paragraph"), 0, "esSyntax"), a.splice(a.indexOf("text"), 0, "esComment");
		};
		var De = "string", de = "array", st = "cursor", Ae = "indent", Te = "align", je = "trim", ke = "group", Fe = "fill", be = "if-break", $e = "indent-if-break", Ke = "line-suffix", Qe = "line-suffix-boundary", ge = "line", Je = "label", Se = "break-parent", Tn = /* @__PURE__ */ new Set([
			st,
			Ae,
			Te,
			je,
		...
		var me = Ib;
		var qb = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
		function Bb(e) {
...
Expected it to be ${n}.`;
		...
		function Pp(e) {
			...
			function n(u) {
				if (u.type === Se && _p(r), u.type === ke) {
					if (r.push(u), t.has(u)) return !1;
					t.add(u);
				}
			}
			function a(u) {
				u.type === ke && r.pop().break && _p(r);
			}
			Bp(e, n, a, !0);
		}
		function Xe(e, t = wr) {
			return Pb(e, (r) => typeof r == "string" ? Sn(t, r.split(`
`)) : r);
		}
		var Le = ar, Ln = ar, Op = ar, Np = ar;
		function Cr(e) {
			return Le(e), {
				type: Ae,
				contents: e
...
`;
		...
		var zp = () => /[#*0-9]\uFE0F?\u20E3|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26AA\u26B0\u26B1\u26BD\u26BE\u26C4\u26C8\u26CF\u26D1\u26E9\u26F0-\u26F5\u26F7\u26F8\u26FA\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2757\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B55\u3030\u303D\u3297\u3299]\uFE0F?|[\u261D\u270C\u270D](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?|[\u270A\u270B](?:\uD83C[\uDFFB-\uDFFF])?|[\u23E9-\u23EC\u23F0\u23F3\u25FD\u2693\u26A1\u26AB\u26C5\u26CE\u26D4\u26EA\u26FD\u2705\u2728\u274C\u274E\u2753-\u2755\u2795-\u2797\u27B0\u27BF\u2B50]|\u26D3\uFE0F?(?:\u200D\uD83D\uDCA5)?|\u26F9(?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|\u2764\uFE0F?(?:\u200D(?:\uD83D\uDD25|\uD83E\uDE79))?|\uD83C(?:[\uDC04\uDD70\uDD71\uDD7E\uDD7F\uDE02\uDE37\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF5\uDFF7]\uFE0F?|[\uDF85\uDFC2\uDFC7](?:\uD83C[\uDFFB-\uDFFF])?|[\uDFC4\uDFCA](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDFCB\uDFCC](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDCCF\uDD8E\uDD91-\uDD9A\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF43\uDF45-\uDF4A\uDF4C-\uDF7C\uDF7E-\uDF84\uDF86-\uDF93\uDFA0-\uDFC1\uDFC5\uDFC6\uDFC8\uDFC9\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF8-\uDFFF]|\uDDE6\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF]|\uDDE7\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF]|\uDDE8\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF7\uDDFA-\uDDFF]|\uDDE9\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF]|\uDDEA\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA]|\uDDEB\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7]|\uDDEC\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE]|\uDDED\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA]|\uDDEE\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9]|\uDDEF\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5]|\uDDF0\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF]|\uDDF1\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE]|\uDDF2\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF]|\uDDF3\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF]|\uDDF4\uD83C\uDDF2|\uDDF5\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE]|\uDDF6\uD83C\uDDE6|\uDDF7\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC]|\uDDF8\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF]|\uDDF9\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF]|\uDDFA\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF]|\uDDFB\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA]|\uDDFC\uD83C[\uDDEB\uDDF8]|\uDDFD\uD83C\uDDF0|\uDDFE\uD83C[\uDDEA\uDDF9]|\uDDFF\uD83C[\uDDE6\uDDF2\uDDFC]|\uDF44(?:\u200D\uD83D\uDFEB)?|\uDF4B(?:\u200D\uD83D\uDFE9)?|\uDFC3(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?|\uDFF3\uFE0F?(?:\u200D(?:\u26A7\uFE0F?|\uD83C\uDF08))?|\uDFF4(?:\u200D\u2620\uFE0F?|\uDB40\uDC67\uDB40\uDC62\uDB40(?:\uDC65\uDB40\uDC6E\uDB40\uDC67|\uDC73\uDB40\uDC63\uDB40\uDC74|\uDC77\uDB40\uDC6C\uDB40\uDC73)\uDB40\uDC7F)?)|\uD83D(?:[\uDC3F\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3]\uFE0F?|[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC](?:\uD83C[\uDFFB-\uDFFF])?|[\uDC6E-\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4\uDEB5](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD74\uDD90](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?|[\uDC00-\uDC07\uDC09-\uDC14\uDC16-\uDC25\uDC27-\uDC3A\uDC3C-\uDC3E\uDC40\uDC44\uDC45\uDC51-\uDC65\uDC6A\uDC79-\uDC7B\uDC7D-\uDC80\uDC84\uDC88-\uDC8E\uDC90\uDC92-\uDCA9\uDCAB-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDDA4\uDDFB-\uDE2D\uDE2F-\uDE34\uDE37-\uDE41\uDE43\uDE44\uDE48-\uDE4A\uDE80-\uDEA2\uDEA4-\uDEB3\uDEB7-\uDEBF\uDEC1-\uDEC5\uDED0-\uDED2\uDED5-\uDED8\uDEDC-\uDEDF\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB\uDFF0]|\uDC08(?:\u200D\u2B1B)?|\uDC15(?:\u200D\uD83E\uDDBA)?|\uDC26(?:\u200D(?:\u2B1B|\uD83D\uDD25))?|\uDC3B(?:\u200D\u2744\uFE0F?)?|\uDC41\uFE0F?(?:\u200D\uD83D\uDDE8\uFE0F?)?|\uDC68(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDC68\uDC69]\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?))?|\uDC69(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?[\uDC68\uDC69]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?|\uDC69\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?))|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFC-\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFD-\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFD\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFE]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFE])))?))?|\uDD75(?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDE2E(?:\u200D\uD83D\uDCA8)?|\uDE35(?:\u200D\uD83D\uDCAB)?|\uDE36(?:\u200D\uD83C\uDF2B\uFE0F?)?|\uDE42(?:\u200D[\u2194\u2195]\uFE0F?)?|\uDEB6(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?)|\uD83E(?:[\uDD0C\uDD0F\uDD18-\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5\uDEC3-\uDEC5\uDEF0\uDEF2-\uDEF8](?:\uD83C[\uDFFB-\uDFFF])?|[\uDD26\uDD35\uDD37-\uDD39\uDD3C-\uDD3E\uDDB8\uDDB9\uDDCD\uDDCF\uDDD4\uDDD6-\uDDDD](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDDDE\uDDDF](?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD0D\uDD0E\uDD10-\uDD17\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCC\uDDD0\uDDE0-\uDDFF\uDE70-\uDE7C\uDE80-\uDE8A\uDE8E-\uDEC2\uDEC6\uDEC8\uDECD-\uDEDC\uDEDF-\uDEEA\uDEEF]|\uDDCE(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?|\uDDD1(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1|\uDDD1\u200D\uD83E\uDDD2(?:\u200D\uD83E\uDDD2)?|\uDDD2(?:\u200D\uD83E\uDDD2)?))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE])))?))?|\uDEF1(?:\uD83C(?:\uDFFB(?:\u200D\uD83E\uDEF2\uD83C[\uDFFC-\uDFFF])?|\uDFFC(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFD-\uDFFF])?|\uDFFD(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])?|\uDFFE(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFD\uDFFF])?|\uDFFF(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFE])?))?)/g;
		var Up = 12288, Hp = 65510, Vp = [
			12288,
			12288,
			65281,
			65376,
		...
		var Yp = 19968, [Vb, Gb] = Wb(Va);
		function Wb(e) {
			let t = e[0], r = e[1];
			for (let n = 0; n < e.length; n += 2) {
				let a = e[n], u = e[n + 1];
				if (Yp >= a && Yp <= u) return [a, u];
				u - a > r - t && (t = a, r = u);
			}
			return [t, r];
		}
		var Wa = (e) => e < Up || e > Hp ? !1 : Ga(Vp, e);
		var Ya = (e) => e >= Vb && e <= Gb ? !0 : e < Gp || e > Wp ? !1 : Ga(Va, e);
		var Yb = /^(?:[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600-\u2604\u260E\u2611\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0\u26F1\u26F4\u26F7\u26F8\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u2764\u27A1\u2934\u2935\u2B05-\u2B07]|\uD83C[\uDD70\uDD71\uDD7E\uDD7F\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF3\uDFF5\uDFF7]|\uD83D[\uDC3F\uDC41\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3])$/, jp = (e) => Yb.test(e);
		var jb = /[^\x20-\x7F]/;
		function $b(e) {
			if (!e) return 0;
			if (!jb.test(e)) return e.length;
			let t = 0;
			e = e.replace(zp(), (r) => (t += jp(r) ? 1 : 2, ""));
			for (let r of e) {
		...
		var Ce = Symbol("MODE_BREAK"), Ne = Symbol("MODE_FLAT"), Ka = Symbol("DOC_FILL_PRINTED_LENGTH");
		...
		function Xp(e, t) {
			let r = Object.create(null), n = t.printWidth, a = Mp(t.endOfLine), u = 0, i = [{
				indent: ja,
				mode: Ce,
				doc: e
			}], o = !1, s = [], l = new Jp();
...
`, a) : g;
					...
					case ke: {
						let k = (function() {
							...
							if (!g.break && _n(w, i, C, S, r)) return w;
		...
		var Xb = Array.prototype.toReversed ?? function() {
			return [...this].reverse();
		}, Zp = qt("toReversed", function() {
		...
		function rE(e) {
			return e = eh(e), decodeURIComponent(e.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, "%25"));
		}
		function nE(e) {
			e = eh(e);
		...
		var th = (e) => String(e).split(/[/\\]/).pop(), rh = (e) => String(e).startsWith("file:");
		function nh(e, t) {
			if (!t) return;
			let r = th(t).toLowerCase();
		...
		function uE(e, t) {
			let r = Zp(0, e.plugins).flatMap((a) => a.languages ?? []);
			return (iE(r, t.language) ?? nh(r, t.physicalFile) ?? nh(r, t.file) ?? ih(r, t.physicalFile) ?? ih(r, t.file) ?? aE?.(r, t.physicalFile))?.parsers[0];
		}
		var Ja = uE;
		function oE(e) {
			return !!e?.[Jr];
		...
		var Za = /* @__PURE__ */ new Set([
			...
			"paragraph",
			"heading"
		]), $t = "non-cjk", Re = "cj-letter", Ct = "k-letter", Tr = "cjk-punctuation", lE = /\p{Script_Extensions=Hangul}/u;
		function Sr(e) {
			let t = [], r = e.split(/([\t\n ]+)/);
...
` : " "
				...
				let i = u.split(new RegExp(`(${uh.source})`, "u"));
...
`) ? r.slice(0, -1) : r;
		...
		var Qt = (e) => e?.type === "whitespace" && e.value === `
`;
		function cE() {
			return (e) => Ee(e, (t, r, [n]) => t.type !== "html" || vp.test(t.value) || Pn.has(n.type) ? t : {
				...t,
				type: "jsx"
			});
		}
		...
		function tu(e) {
			let t = (0, mh.default)().use(hh.default, {
				commonmark: !0,
				blocks: [yp]
			}).use(fh.default).use(ah).use(ph.default).use(Lp).use(lh).use(sh).use(ch);
			return t.run(t.parse(e));
		}
		var Dh = "format";
		var dh = /<!--\s*@(?:noformat|noprettier)\s*-->|\{\s*\/\*\s*@(?:noformat|noprettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:noformat|noprettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/m, gh = /<!--\s*@(?:format|prettier)\s*-->|\{\s*\/\*\s*@(?:format|prettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:format|prettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/m;
		var Rn = (e) => Ve(e).content.trimStart().match(gh)?.index === 0, xh = (e) => Ve(e).content.trimStart().match(dh)?.index === 0, kh = (e) => {
			let { frontMatter: t } = Ve(e), r = `<!-- @${Dh} -->`;
			return t ? `${t.raw}
...
${e}`;
			...
			switch (r.type) {
				case "code": {
					...
					return n === "angular-ts" ? a = Ja(t, { language: "typescript" }) : n === "angular-html" ? a = "angular" : a = Ja(t, { language: n }), a ? async (u) => {
						...
						let o = await u(t.parser === "mdx" ? On(r, t.originalText) : r.value, i), s = t.__inJsTemplate ? "~" : "`", l = s.repeat(Math.max(3, Mn(r.value, s) + 1));
						return yr([
							l,
							r.lang,
							r.meta ? " " + r.meta : "",
		...
		var bh = dE;
		var nu = At(mn(), 1);
		var xE = /* @__PURE__ */ new Set(["position", "raw"]);
		function iu(e, t, r) {
...
`, " ")), (e.type === "definition" || e.type === "linkReference" || e.type === "imageReference") && (t.label = (0, nu.default)(e.label)), e.type === "imageReference" && e.referenceType === "collapsed" && (t.alt = (0, nu.default)(e.alt)), (e.type === "link" || e.type === "image") && e.url && e.url.includes("(")) for (let n of "<>") t.url = X(0, e.url, n, encodeURIComponent(n));
		...
		var wE = /* @__PURE__ */ new Set(["listItem", "definition"]);
		function CE(e, t) {
			let { node: r, previous: n, parent: a } = e;
			if (t.parser === "mdx") {
				if (Ah(n, t) || r.type === "list" && a.type === "listItem" && (n.type === "code" || n.type === "paragraph") && n.position.end.line + 1 < r.position.start.line) return !0;
			} else {
			...
			t.parser === "mdx" ? o = a.type === "listItem" && (r.type === "list" || !Ah(a, t)) : o = a.type === "listItem" && (r.type === "list" || !e.callParent(Th));
...
`, u - 1) + 1, o = n.slice(i, u), s = Math.max(o.indexOf("="), o.indexOf("-")), l = o.slice(s);
		...
		function qh(e, t, r) {
			...
			return ae(e, t, r, { processor() {
				let o = l(), { node: s } = e;
				if (s.children.length === 2 && s.children[1].type === "html" && s.children[0].position.start.column !== s.children[1].position.start.column) return [o, Lh(e, t, r, o)];
				return [o, we(" ".repeat(o.length), Lh(e, t, r, o))];
				function l() {
					let c = n.ordered ? (e.isFirst ? n.start : u ? 1 : Math.min(n.start + e.index, TE)) + (a % 2 === 0 ? ". " : ") ") : a % 2 === 0 ? "- " : "* ", f = n.isAligned && n.ordered ? _h(c, t) : c;
		...
		function Lh(e, t, r, n) {
			...
			return [u, ae(e, t, r, { processor({ node: i, isFirst: o }) {
				...
				let s = " ".repeat(Ph(t.tabWidth - n.length, 0, 3));
				return [s, we(s, r())];
			} })];
		}
		function SE(e) {
		...
		function Bh(e, t, r) {
			...
			return ae(e, t, r, { processor() {
				let i = s(), { node: o } = e;
				if (o.children.length === 2 && o.children[1].type === "html" && o.children[0].position.start.column !== o.children[1].position.start.column) return [i, Ih(e, t, r, i)];
				return [i, we(" ".repeat(i.length), Ih(e, t, r, i))];
				function s() {
					let l = n.ordered ? (e.isFirst ? n.start : u ? 1 : n.start + e.index) + (a % 2 === 0 ? ". " : ") ") : a % 2 === 0 ? "- " : "* ";
					return (n.isAligned || n.hasIndentedCodeblock) && n.ordered ? _h(l, t) : l;
				}
			} });
		}
		function Ih(e, t, r, n) {
		...
		function BE(e, t) {
			...
			return zh(a) && zh(u) || a === Ct && u === Re || u === Ct && a === Re ? !0 : a === Tr || u === Tr || a === Re && u === Re ? !1 : Mh.has(n.value[0]) || Mh.has(J(0, r.value, -1)) ? !0 : r.hasTrailingPunctuation || n.hasLeadingPunctuation ? !1 : qE(e);
		}
		function zh(e) {
			return e === $t || e === Ct;
		}
...
` && BE(e, n);
		...
		function Hh(e) {
			let { node: t } = e, r = X(0, X(0, t.value, "*", "\\*"), new RegExp([`(^|${Ze.source})(_+)`, `(_+)(${Ze.source}|$)`].join("|"), "gu"), (u, i, o, s, l) => X(0, o ? `${i}${o}` : `${s}${l}`, "_", "\\_")), n = (u, i, o) => u.type === "sentence" && o === 0, a = (u, i, o) => Nn(u.children[o - 1]);
		...
		function lu(e, t, r) {
			...
			switch (n.type) {
				...
				case "paragraph": return Oh(e, t, r);
				case "sentence": return Nh(e, r);
				case "word": return t.parser !== "mdx" ? Uh(e, t) : Hh(e);
				case "whitespace": {
				...
				case "emphasis": {
					let a;
					if (Nn(n.children[0])) a = t.originalText[n.position.start.offset];
					else {
						let u = Vh(e), i = e.callParent(({ node: o }) => o.type === "strong" && Vh(e));
...
`, " ");
					...
					let u = Eh(a, "`"), i = "`".repeat(u), o = a.startsWith("`") || a.endsWith("`") || /^[\n ]/.test(a) && /[\n ]$/.test(a) && /[^\n ]/.test(a) ? " " : "";
					return [
						i,
						o,
						a,
				...
				case "heading": return Sh(e, t, r);
				case "code": {
					if (n.isIndented) {
						let i = " ".repeat(4);
						return we(i, [i, Xe(n.value, Z)]);
					}
					let a = t.__inJsTemplate ? "~" : "`", u = a.repeat(Math.max(3, Mn(n.value, a) + 1));
					return [
						u,
						n.lang || "",
						n.meta ? " " + n.meta : "",
						Z,
						Xe(t.parser === "mdx" ? On(n, t.originalText) : n.value, Z),
						Z,
						u
					];
				}
				...
				case "list": return t.parser === "mdx" ? Bh(e, t, r) : qh(e, t, r);
				case "thematicBreak": {
				...
				case "footnoteReference": return Wh(n);
				case "footnoteDefinition": {
					...
					return [
						Wh(n),
						": ",
						a ? ae(e, t, r) : jt([we(" ".repeat(4), ae(e, t, r, { processor: ({ isFirst: u }) => u ? jt([qn, r()]) : r() }))])
					];
				}
				case "table": return Rh(e, t, r);
				...
				default: throw new vh(n, "Markdown");
			}
		}
		function ME(e, t, r) {
		...
		function Un(e, t, r = !0) {
			...
			let n = yh(e, t.singleQuote);
			return e = X(0, e, "\\", "\\\\"), e = X(0, e, n, `\\${n}`), `${n}${e}${n}`;
		}
		function zn(e, t) {
			let r = (0, jh.default)(e.label);
...
`);
		...
		function rw(e, t) {
			...
			return Ee(e, (n) => {
				if (n.type === "image" || n.type === "imageReference") return n.originalAltText = Kh(r, n.position.start.offset, n.position.end.offset), n;
