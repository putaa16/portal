...
var require_babel = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(f) {
		...
		var $t = (a, e) => {
			for (var t in e) qt(a, t, {
				get: e[t],
				enumerable: !0
			});
		}, ai = (a, e, t, s) => {
			if (e && typeof e == "object" || typeof e == "function") for (let i of ii(e)) !ri.call(a, i) && i !== t && qt(a, i, {
				get: () => e[i],
		...
		var lt = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty);
		var L = class {
			constructor(e, t, s) {
		...
		var Be = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", li = {
		...
		}, wt = (a) => a.type === "UpdateExpression" ? Re.UpdateExpression[`${a.prefix}`] : Re[a.type], pi = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
		...
		function xi({ toMessage: a, code: e, reasonCode: t, syntaxPlugin: s }) {
			...
			return function r(n, o, h) {
				...
				}), Ue(c, "details", h), Object.defineProperty(c, "message", {
					configurable: !0,
					get() {
		...
		}, A = !0, y = !0, zt = !0, pt = !0, V = !0, bi = !0, kt = class {
			label;
			keyword;
			beforeExpr;
			startsExpr;
		...
		function g(a, e = {}) {
			return ++mt, be.push(a), Ae.push(e.binop ?? -1), Se.push(e.beforeExpr ?? !1), Ce.push(e.startsExpr ?? !1), Ee.push(e.prefix ?? !1), Te.push(new kt(a, e)), mt;
		}
		function b(a, e = {}) {
			return ++mt, ge.set(a, mt), be.push(a), Ae.push(e.binop ?? -1), Se.push(e.beforeExpr ?? !1), Ce.push(e.startsExpr ?? !1), Ee.push(e.prefix ?? !1), Te.push(new kt("name", e)), mt;
		}
		var Ai = {
			bracketL: g("[", {
				beforeExpr: A,
		...
		var Q = class {
			...
			787719,
			239
		], Oi = new RegExp("[" + ts + "]"), Fi = new RegExp("[" + ts + Di + "]");
		function Yt(a, e) {
			let t = 65536;
		...
		function R(a) {
			return a < 65 ? a === 36 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Oi.test(String.fromCharCode(a)) : Yt(a, es);
		}
		function W(a) {
			return a < 48 ? a === 36 : a < 58 ? !0 : a < 65 ? !1 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Fi.test(String.fromCharCode(a)) : Yt(a, es) || Yt(a, Mi);
		}
		var Ie = {
			keyword: [
				"break",
		...
		}, Bi = new Set(Ie.keyword), Ri = new Set(Ie.strict), Ui = new Set(Ie.strictBind);
		function ss(a, e) {
		...
		var Ji = /\*?\s*@((?:no)?flow)\b/, Gi = (a) => class extends a {
			...
			flowParseDeclareModule(t) {
				...
				let r = null, n = !1;
				return i.forEach((o) => {
					Hi(o) ? (r === "CommonJS" && this.raise(P.AmbiguousDeclareModuleKind, o), r = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(P.DuplicateDeclareModuleExports, o), r === "ES" && this.raise(P.AmbiguousDeclareModuleKind, o), r = "CommonJS", n = !0);
			...
			flowParseObjectType({ allowStatic: t, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
				...
				for (s && this.match(3) ? (this.expect(3), c = 5, p = !0) : (this.expect(2), c = 4, p = !1), h.exact = p; !this.match(c);) {
					...
					if (this.eat(0)) T != null && this.unexpected(T), this.eat(0) ? (E && this.unexpected(E.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(v, x))) : h.indexers.push(this.flowParseObjectTypeIndexer(v, x, E));
						...
						let I = "init";
						if (this.isContextual(95) || this.isContextual(100)) Qe(this.lookahead().type) && (I = this.state.value, this.next());
			...
			getArrowLikeExpressions(t, s) {
				...
				return s ? (r.forEach((n) => this.finishArrowValidation(n)), [r, []]) : Wi(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
			}
			...
			parseImportSpecifierLocal(t, s, i) {
				s.local = Ve(t) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), t.specifiers.push(this.finishImportSpecifier(s, i));
			}
...
`);
				...
				case 120: {
					let c;
					return {code: c, pos: e} = ae(a, e, t, s, 2, !1, n, r), o(c === null ? null : String.fromCharCode(c));
				}
				case 117: {
					let c;
		...
		function ae(a, e, t, s, i, r, n, o) {
			let h = e, c;
			return {n: c, pos: e} = os(a, e, t, s, 16, i, r, !1, o, !n), c === null && (n ? o.invalidEscapeSequence(h, t, s) : e = h - 1), {
				code: c,
				pos: e
			};
		}
		function os(a, e, t, s, i, r, n, o, h, c) {
			let p = e, f = i === 16 ? $e.hex : $e.decBinOct, d = i === 16 ? Ct.hex : i === 10 ? Ct.dec : i === 8 ? Ct.oct : Ct.bin, x = !1, T = 0;
			for (let D = 0, v = r ?? Infinity; D < v; ++D) {
				...
				if (E >= 97 ? I = E - 97 + 10 : E >= 65 ? I = E - 65 + 10 : er(E) ? I = E - 48 : I = Infinity, I >= i) {
					if (I <= 9 && c) return {
						n: null,
						pos: e
					};
		...
		function hs(a, e, t, s, i, r) {
			...
			if (n === 123) {
				if (++e, {code: o, pos: e} = ae(a, e, t, s, a.indexOf("}", e) - e, !0, i, r), ++e, o !== null && o > 1114111) if (i) r.invalidCodePoint(e, t, s);
				else return {
					code: null,
					pos: e
				};
		...
		var rr = /* @__PURE__ */ new Set([
			...
			tokens = [];
			constructor(e, t) {
				super(), this.state = new re(), this.state.init(e), this.input = t, this.length = t.length, this.comments = [], this.isLookahead = !1, (!Et || Et.length < (this.length + 1) * 2) && (Et = new Uint32Array((this.length + 1) * 2)), this.locData = Et;
			}
			setLoc(e) {
				...
				t: for (; this.state.pos < this.length;) {
					...
					switch (s) {
						...
						case 47:
							...
							break;
						default: if (Yi(s)) ++this.state.pos;
			...
			readInt(e, t, s = !1, i = !0) {
				let { n: r, pos: n } = os(this.input, this.state.pos, this.state.lineStart, this.state.curLine, e, t, s, i, this.errorHandlers_readInt, !1);
...
`),
			...
			parseFunctionBody(e, t, s = !1) {
				...
				if (this.expressionScope.enter(cs()), i) e.body = this.parseMaybeAssign(), this.checkParams(e, !1, t, !1);
				else {
		...
		function Pe(a) {
			...
			switch (a.type) {
				...
				case "MemberExpression": return !a.computed && Pe(a.object);
				case "TSInstantiationExpression": return Pe(a.expression);
				default: return !1;
			}
		}
		var dr = (a) => class extends a {
			...
			tsParseModifiers({ allowedModifiers: t, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = m.InvalidModifierOnTypeMember }, n) {
				...
				for (;;) {
					...
					if (!p) break;
					We(p) ? n.accessibility ? this.raise(m.DuplicateAccessibilityModifier, c, { modifier: p }) : (o(c, p, p, "override"), o(c, p, p, "static"), o(c, p, p, "readonly"), n.accessibility = p) : fr(p) ? (n[p] && this.raise(m.DuplicateModifier, c, { modifier: p }), n[p] = !0, o(c, p, "in", "out")) : (lt(n, p) ? this.raise(m.DuplicateModifier, c, { modifier: p }) : (o(c, p, "static", "readonly"), o(c, p, "static", "override"), o(c, p, "override", "readonly"), o(c, p, "abstract", "override"), h(c, p, "declare", "override"), h(c, p, "static", "abstract")), n[p] = !0), s?.includes(p) && this.raise(r, c, { modifier: p });
				}
			}
		...
		function mr(a) {
			...
			return e && t.type !== "StringLiteral" && (t.type !== "TemplateLiteral" || t.expressions.length > 0) ? !1 : us(a.object);
		}
		function yr(a, e) {
			let { type: t } = a;
			if (a.extra?.parenthesized) return !1;
		...
		function us(a) {
			return a.type === "Identifier" ? !0 : a.type !== "MemberExpression" || a.computed ? !1 : us(a.object);
		}
		var Je = F`placeholders`({
			ClassNameIsRequired: "A class name is required.",
			UnexpectedSpace: "Unexpected space in placeholder."
		}), gr = (a) => class extends a {
			parsePlaceholder(t) {
				if (this.match(129)) {
					let s = this.startNode();
		...
		var fs = {
			...
			v8intrinsic: Tr,
			placeholders: gr
		}, Ar = Object.keys(fs), Lt = class extends xe {
			constructor(e, t, s) {
				let i = gi(e);
...
`) return e + 2;
		...
		var Ps = wr;
		function Ir(a, e) {
			return e === !1 ? !1 : a.charAt(e) === "/" && a.charAt(e + 1) === "/" ? ms(a, e) : e;
		}
		var gs = Ir;
		function Nr(a, e) {
			let t = null, s = e;
...
`);
		...
		var Or = 5, Fr = 8, Br = 8, Cs = (a) => (e) => e.label ? k(e.label) : N(e) + a, Rr = (a) => a.__contentEnd ?? rt(a), Es = [
			"ExpressionStatement",
			"Directive",
			"ImportDeclaration",
...
`)) {
		...
		function Qr(a) {
			...
			let o = ` (${i}:${r})`;
			return e.endsWith(o) && (e = e.slice(0, -o.length)), e.startsWith(js) && (e = e.slice(js.length)), Ut(e, {
				loc: { start: {
					line: i,
					column: r + 1
				} },
...
`);
			...
			let s = Object.create(null), i = U(0, a, qs, "").replace(Vs, "").trimEnd(), r;
			for (; r = qs.exec(a);) {
				let n = U(0, r[2], sa, "");
		...
		function Ws(a) {
			...
			let { pragmas: s, comments: i } = zs($s(a));
			return {
				shebang: e,
				text: a,
				pragmas: s,
		...
		var ot = (a) => G(ua(a)), ha = {
			...
			tokens: !1,
			ranges: !1
		}, Ys = "v8intrinsic", Qs = [["pipelineOperator", {
			proposal: "hack",
			topicToken: "%"
		}], ["pipelineOperator", { proposal: "fsharp" }]], j = (a, e = ha) => ({
			...e,
			plugins: [...e.plugins, ...a]
		}), ca = /@(?:no)?flow\b/;
		function la(a, e) {
		...
		]), Zs = [j(["jsx"])], ma = ot({ optionsCombinations: Zs }), ya = ot({ optionsCombinations: [j(["jsx", "typescript"]), j(["typescript"])] }), xa = ot({
			isExpression: !0,
			optionsCombinations: [j(["jsx"])]
		}), Pa = ot({
			isExpression: !0,
			optionsCombinations: [j(["typescript"])]
		}), ti = ot({ optionsCombinations: [j([
			"jsx",
			["flow", { all: !0 }],
			"flowComments"
		...
		var Aa = G({
			...
			hasPragma: () => !0,
			hasIgnorePragma: () => !1
		}), Sa = G((a) => bt(a)), Ca = G((a) => bt(a, { allowEmpty: !0 })), Ea = G({
