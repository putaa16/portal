...
var LTR_REGEX = /* @__PURE__ */ new RegExp("^[^֑-߿יִ-﷽ﹰ-ﻼ]*[A-Za-zÀ-ÖØ-öø-ʸ̀-֐ࠀ-῿‎Ⰰ-﬜︀-﹯﻽-￿]");
...
function $onCompositionEndImpl(editor, data) {
	...
	if (compositionKey !== null && data != null) {
		if (data === "") {
			...
			if (textNode !== null && textNode.nodeValue !== null && $isTextNode(node)) $updateTextNodeFromDOMContent(node, textNode.nodeValue, null, null, true);
			return;
		}
...
function updateDOMSelection(prevSelection, nextSelection, editor, domSelection, tags, rootElement, nodeCount) {
	...
	if (isCollapsed && (prevSelection === null || anchorFormatOrStyleChanged || $isRangeSelection(prevSelection) && (prevSelection.format !== nextFormat || prevSelection.style !== nextStyle))) markCollapsedSelectionFormat(nextFormat, nextStyle, nextAnchorOffset, anchorKey, performance.now());
